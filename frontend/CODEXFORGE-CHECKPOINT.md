...
CodexForge checkpoint documentation now records through phase 1337.

The latest family is the backend guarded apply/run preview release-candidate layer for phases 1322-1337. It covers Backend Guarded Apply Run Boundary, Backend Guarded Apply Contract, Backend Guarded Run Contract, Backend Guarded Combined Apply Run Contract, Backend Guarded Path Guard Contract, Backend Guarded Command Guard Contract, Backend Guarded Approval Enforcement Contract, Backend Guarded Evidence Contract, Backend Guarded Result Contract, Backend Guarded Recovery Contract, Backend Guarded Audit Contract, Backend Guarded Queue State Contract, Backend Guarded Denied Path Review, Backend Guarded Go No-Go Review, First Backend Guarded Apply Run Candidate, and Controlled Backend Guarded Apply Run Preview Release Candidate surfaces. These surfaces remain static, deterministic, preview-only, cockpit-centered, and approval-gated; they do not call models, send prompts, write files, apply diffs, run commands, persist approvals, create queues, release locks, persist evidence/results/audit logs, execute rollback/retry/recovery, start runtimes, spawn processes, bind ports, call providers/connectors/adapters, execute backend services, export files, run a real operator trial, or promote memory.
