...
CodexForge checkpoint documentation now records through phase 1305.

The latest family is the real controlled operator trial packet release-candidate layer for phases 1290-1305. It covers Real Controlled Operator Trial Packet Boundary, Real Trial Goal Packet, Project Context Packet, File Write Packet, Command Packet, Approval Packet, Execution Hold Packet, Evidence Capture Packet, Result Capture Packet, Recovery Packet, Audit Packet, Operator Checklist, Denied Path Checklist, Go No-Go Review, First Real Controlled Operator Trial Candidate, and Controlled Real Operator Trial Packet Release Candidate surfaces. These surfaces remain static, deterministic, preview-only, cockpit-centered, and approval-gated; they do not call models, send prompts, write files, run commands, persist approvals, create queues, release locks, persist evidence/results/audit logs, execute rollback/retry/recovery, start runtimes, spawn processes, bind ports, call providers/connectors/adapters, export files, run a real operator trial, or promote memory.
