...
CodexForge checkpoint documentation now records through phase 1321.

The latest family is the backend approval handoff release-candidate layer for phases 1306-1321. It covers Backend Approval Handoff Boundary, Backend Approval Ticket Contract, Backend File Write Handoff Contract, Backend Command Handoff Contract, Backend Evidence Handoff Contract, Backend Result Handoff Contract, Backend Recovery Handoff Contract, Backend Audit Handoff Contract, Backend Queue Handoff Contract, Backend Approval Denied Path Matrix, Backend Approval Operator Signoff, Backend Approval Go No-Go Review, Backend Handoff Security Review, Backend Handoff Failure Review, First Backend Approval Handoff Candidate, and Controlled Backend Approval Handoff Release Candidate surfaces. These surfaces remain static, deterministic, preview-only, cockpit-centered, and approval-gated; they do not call models, send prompts, write files, run commands, persist approvals, create queues, release locks, persist evidence/results/audit logs, execute rollback/retry/recovery, start runtimes, spawn processes, bind ports, call providers/connectors/adapters, execute backend services, export files, run a real operator trial, or promote memory.
