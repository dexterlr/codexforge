...
CodexForge checkpoint documentation now records through phase 1721.

The latest completed batch is 1706-1721 - Profit Lockbox + Reinvestment Rules v1. The latest family adds deterministic profit lockbox boundary, realised profit definition preview, protected profit bucket rules preview, reinvestable profit bucket rules preview, lock percentage rule preview, release condition rule preview, reinvestment ceiling rule preview, loss handling rule preview, active capital update preview, protected profit audit preview, reinvestment approval gate preview, profit evidence map preview, cockpit profit lockbox summary, denied money movement boundary, first profit lockbox reinvestment candidate, and controlled profit lockbox reinvestment release candidate surfaces. Latest release candidate: Controlled Profit Lockbox Reinvestment Release Candidate. The cockpit now includes safe profit lockbox and reinvestment rule previews below Backtest + Paper Trading Engine while phase pages remain dev test diagnostics only. Profit lockbox and reinvestment rules remain review-only. frontend money movement still blocked. frontend profit withdrawal still blocked. frontend reinvestment execution still blocked. frontend live P&L reads still blocked. frontend broker connection and trade placement still blocked. frontend financial advice still blocked. frontend financial advice, personalised recommendations, buy sell instructions, guaranteed profit claims, trading automation, money movement, profit withdrawal, reinvestment execution, order sizing, and live account monitoring remain blocked from the frontend. backend-owned broker boundary remains required. Explicit operator approval remains required. Next likely batch: 1722-1737 - Broker Execution Boundary.
