...
CodexForge is checkpointed through phase 513, detected from the local `scripts/smoke-codexforge-all.ps1` registry by taking the highest `Phase N` entry. The latest detected milestone family is the multi-workflow operator trial planning, controlled live capability signoff, and Daily Beta release/trial/feedback review-only surface.
...
- Latest detected milestone family: multi-workflow operator trial planning, controlled live capability signoff, and Daily Beta release/trial/feedback review-only preparation.
...
- Safety copy, hidden smoke markers, deterministic builders, and smoke scripts cover the provider/local/connector/automation/unified/beta/Beta 2/final policy polish/Foundation 500/real daily workflow/multi-workflow/Daily Beta review checkpoint surface.
...
- Current checkpoint: documentation and hygiene alignment through detected phase 513.
