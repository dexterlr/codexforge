...
CodexForge is checkpointed through phase 1929, detected from the local `scripts/smoke-codexforge-all.ps1` registry by taking the highest `Phase N` entry. The latest completed batch is 1914-1929 - Video Creation Domain Boundary v1. The latest detected milestone family adds Video Creation Domain Boundary, Video Workspace Intake Preview, Video Project Brief Preview, Video Audience And Goal Preview, Video Format Boundary Preview, Video Safety And Rights Boundary Preview, Video Asset Planning Boundary Preview, Video Script Planning Boundary Preview, Video Storyboard Planning Boundary Preview, Video Voiceover Planning Boundary Preview, Video Caption Planning Boundary Preview, Video Render Job Blocked Boundary Preview, Video Export Blocked Boundary Preview, Cockpit Video Creation Domain Summary, First Video Creation Domain Boundary Candidate, and Controlled Video Creation Domain Boundary Release Candidate surfaces. `/codexforge-cockpit` remains the one normal user UX with Start with a goal, Trading Workspace, Build Workspace, Creative Workspace, Approvals, Evidence & Audit, Next Action, and Developer Diagnostics sections. Creative Workspace includes safe video creation domain boundary previews below Controlled Paper Trading Workspace. Phase pages remain dev test diagnostics only, main menu hides phase spam, diagnostics remain searchable and directly accessible, no routes were deleted, no smoke coverage was deleted, no execution was enabled, video creation domain remains review-only, video creation remains planning-only, synthetic data only, frontend rendering still blocked, frontend export still blocked, frontend upload/download still blocked, frontend file generation still blocked, frontend asset persistence still blocked, frontend prompt persistence still blocked, frontend job persistence still blocked, frontend approval persistence still blocked, frontend provider calls still blocked, frontend model calls still blocked, frontend connector calls still blocked, frontend image generation still blocked, frontend video generation still blocked, frontend voice generation still blocked, frontend publishing still blocked, frontend scheduling still blocked, backend-owned asset storage remains required, backend-owned render service remains required, backend-owned export service remains required, backend-owned provider gateway remains required, backend-owned rights review remains required, backend-owned approval capture remains required, operator review remains required, and explicit operator approval remains required. Trading workspace remains review-only and no-live-transition.
...
- Highest detected phase: 1929.
- Checkpoint date: 2026-07-01.
- Latest completed batch: 1914-1929 - Video Creation Domain Boundary v1.
- Latest detected milestone family: Video Creation Domain Boundary v1.
- Latest release candidate: Controlled Video Creation Domain Boundary Release Candidate.
- Next likely batch: 1930-1945 - Script And Storyboard Workspace v1.
...
Phases 1194-1209 cover the unified cockpit foundation and establish `/codexforge-cockpit` as the preferred normal user surface. Phases 1210-1225 through 1913 add cockpit, local change, build/fix, guided operator, execution readiness, backend approval, guarded apply/run, daily-testable cockpit, project context, goal compiler, plan/diff/command, evidence memory, backend queue, transaction, command safety, audit trail, model router, provider approval, local model bridge, specialist worker, game server, domain pack, trading research, mandate, strategy lab, backtest/paper, profit lockbox, cockpit navigation cleanup, broker boundary, paper broker simulator, paper result ledger, paper review dashboard, strategy performance review, strategy change control, strategy version registry, paper strategy promotion gate, paper trading end-to-end review, cockpit trading workflow polish, and controlled paper trading workspace release candidate surfaces. Phases 1914-1929 cover Video Creation Domain Boundary through Controlled Video Creation Domain Boundary Release Candidate. These surfaces keep `/codexforge-cockpit` current through phase 1929 as the one normal user UX while phase pages remain dev test diagnostics only. Latest completed batch: 1914-1929 - Video Creation Domain Boundary v1. Latest release candidate: Controlled Video Creation Domain Boundary Release Candidate. Video creation domain remains review-only, planning-only, and synthetic-only. Backend-owned asset storage, render service, export service, provider gateway, rights review, and approval capture remain required. Operator review and explicit operator approval remain required. Frontend rendering, export, upload/download, file generation, asset persistence, prompt persistence, job persistence, approval persistence, provider calls, model calls, connector calls, image generation, video generation, voice generation, publishing, scheduling, and performance guarantees remain blocked from the cockpit until explicit operator approval and backend-owned services exist. Trading workspace remains review-only and no-live-transition. Next likely batch: 1930-1945 - Script And Storyboard Workspace v1.
