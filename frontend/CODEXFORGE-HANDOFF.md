...
CodexForge checkpoint documentation now records through phase 1673.

The latest completed batch is 1658-1673 - Trading Mandate + Risk Governor v1. The latest family adds deterministic trading mandate boundary, capital allocation rules preview, active capital ledger preview, protected profit bucket preview, reinvestable profit rules preview, max daily loss guard preview, max drawdown guard preview, position risk guard preview, approved market universe preview, approved symbol universe preview, approved strategy class preview, trade thesis requirement preview, trading evidence requirement preview, trading kill switch preview, first trading mandate risk governor candidate, and controlled trading mandate risk governor release candidate surfaces. Phase pages remain dev test diagnostics only. Latest release candidate: Controlled Trading Mandate Risk Governor Release Candidate. The cockpit now includes safe trading mandate and risk-governor previews with Capital Allocation, Active Capital, Protected Profit, Reinvestable Profit, Max Daily Loss, Max Drawdown, Position Risk, Approved Markets, Approved Symbols, Approved Strategies, Trade Thesis Required, Evidence Required, and Kill Switch. Trading remains review-only. frontend broker connection and trade placement still blocked. frontend live market data calls still blocked. frontend financial advice still blocked. frontend guaranteed profit claims still blocked. frontend trading automation still blocked. backend-owned broker boundary remains required. Explicit operator approval remains required. Next likely batch: 1674-1689 - Strategy Lab + Signal Engine.
