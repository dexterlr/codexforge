...
export default function ValidationCaptureHardeningPanelPageClient() {
  return <CodexForgeAppShell activePath="/validation-results/hardening" workspaceLabel="Harden validation capture" nextActionContext={{ hasRegressionOrFixWork: true, hasFileWork: true }} focusMode contentMaxWidth="wide" pageChrome="minimal" showRightRail={false} showSidebarBadges={false} showSidebarSafetyNotice={false} showHeroRouteChips={false}>
    ...
    <ValidationCaptureHardeningPanel />
  </CodexForgeAppShell>;
}
