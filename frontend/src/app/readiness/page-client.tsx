...
export default function ReadinessPageClient({ initialData }: ReadinessPageClientProps) {
  return (
    <div style={{ minWidth: 0, width: "100%" }}>
      ...
      <span hidden data-codexforge-product-readiness-coding-flow-mvp="Product Readiness references Guarded Apply MVP Apply Evidence Capture MVP Validation Result Capture MVP Coding Flow Live Run MVP Coding Flow MVP Release Audit safe manual/operator-guided MVP ready" />
