...
const SURFACE_MAP: readonly HomeSurfaceMapItem[] = [
  ...
  { path: "/first-task", label: "First safe task" },
  { path: "/safety-coach", label: "Safety Coach" },
  { path: "/help-empty-states", label: "Helpful Empty States" },
  { path: "/assisted-quality", label: "Assisted MVP Quality" },
