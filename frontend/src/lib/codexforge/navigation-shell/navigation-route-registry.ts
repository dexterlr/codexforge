...
const ROUTE_DEFAULTS: Record<CodexForgeNavigationRouteHref, CodexForgeNavigationRoute> = {
  ...
  "/files": {
    id: "files",
    href: "/files",
    label: "Project Reader + Patch Preview",
    shortLabel: "Files",
    description: "Real local project reader with read-only tree, file preview, metadata, purpose, risk, and Real Patch Preview v1 functional/preview-only diff handoff.",
    group: "Engineering",
    readiness: "available",
