...
export const CODEXFORGE_PRIMARY_PRODUCT_AREAS: readonly CodexForgePrimaryProductArea[] = [
  ...
  { label: "Generate", href: "/ai", summary: "Action-first request and planning surface with safe review boundaries.", badge: "Plan" },
  ...
  { label: "Developer Diagnostics", href: "/developer-diagnostics-hub-preview", summary: "Diagnostic routes stay reachable but secondary to the product path.", badge: "Secondary" }
] as const;
