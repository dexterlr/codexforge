...
export function ModelCapabilitySummaryPanel() { return <section style={panel}><h2 style={title}>Summary</h2><p style={copy}>Approximate/manual labels only. No fake exact pricing, no provider API calls, and no secret display.</p></section>; }
