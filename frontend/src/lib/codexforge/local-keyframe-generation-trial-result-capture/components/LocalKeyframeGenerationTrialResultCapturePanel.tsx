  ...
  return (
    ...
    >
      ...
      <PreviewFoundationCard title="Plain-English status">
        ...
        <PreviewFoundationCopy>
          This result capture surface reviews supplied keyframe result metadata only. It does not submit ComfyUI jobs,
          mutate files, auto-open local files, call appendEvent, call saveBrainGraph, mutate the Brain graph, or
          auto-promote memory.
        </PreviewFoundationCopy>
      </PreviewFoundationCard>
      <section id="local-keyframe-generation-trial-result-capture" style={previewStyles.grid}>
        {model.results.map((result) => (
          <PreviewFoundationCard
            key={buildLocalKeyframeGenerationTrialResultCaptureStableKey(
              "local-keyframe-result-capture-card",
              result.id
            )}
          ...
          >
            <PreviewFoundationPillList
              items={[
                ...
                result.sourceSubmitTrialImageDependency,
                result.promptWorkflowSummary,
                result.keyframeArtifactSummary,
                result.safetyRedactionStatus,
                result.reviewInboxHandoff,
                result.localOutputArtifactRoute,
