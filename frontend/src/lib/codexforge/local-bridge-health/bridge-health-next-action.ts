...
const ACTIONS: readonly BridgeHealthNextAction[] = [
  ...
  { id: "run-creative-execution-sandbox", label: "Run Creative Execution Sandbox simulation", reason: "Sandbox simulation before future real executor or health probe.", route: "/creative-sandbox", priority: 60, copyPrompt: "Review Creative Execution Sandbox and Creative Readiness Audit before any future real executor or Future Guarded Health Probe. Simulation-only: no probes, no execution, no local HTTP calls, no file writes." },
