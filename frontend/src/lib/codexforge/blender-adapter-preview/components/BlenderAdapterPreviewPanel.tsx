      ...
      <section style={hero}>
        <div style={{ minWidth: 0 }}>
          ...
          <p style={lede}>
            ...
            Cross-link to Video Render Job Preview for render queue and future executor packet planning, Creative Execution Sandbox for lifecycle simulation, Creative Readiness for audit-only real executor readiness, or Unreal Adapter Preview for cinematic/level handoff planning.
          </p>
