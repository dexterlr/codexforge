...
export function StoryboardProjectPanel({ project }: { project: StoryboardProject }) { return <article style={card}><h2 style={title}>Project</h2><p style={copy}>{project.idea}</p><p style={copy}>Audience: {project.audience}</p><p style={copy}>Next step: {project.nextStep}</p></article>; }
