export type LiveWorkflowEvidenceCaptureReviewStatus = "ready-for-review" | "blocked";

export type LiveWorkflowEvidenceCaptureReview = {
  id: string;
  liveWorkflowEvidenceCaptureIdentity: string;
  evidenceCaptureGroups: string[];
  sourceCitationChecklist: string[];
  redactionChecklist: string[];
  deniedEvidenceActions: string[];
  retentionBoundaryNotes: string[];
  blockedEvidenceRisks: string[];
  resultReviewInboxRoute: string;
  operatorFeedbackRoute: string;
  nextRecommendedAction: string;
  status: LiveWorkflowEvidenceCaptureReviewStatus;
  advancedEvidenceDetails: string;
};

export type LiveWorkflowEvidenceCaptureReviewBoundary = {
  reviewOnly: true;
...
export type LiveWorkflowEvidenceCaptureReviewModel = {
  title: "Live workflow evidence capture review";
  summary: string;
  reviews: LiveWorkflowEvidenceCaptureReview[];
  boundary: LiveWorkflowEvidenceCaptureReviewBoundary;
  reviewLanguage: string[];
  advancedDetails: string[];
};

export function buildLiveWorkflowEvidenceCaptureReviewStableKey(
