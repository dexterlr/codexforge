export type AutomationDryRunTrialReviewStatus = "ready-for-review" | "blocked";

export type AutomationDryRunTrialReview = {
  id: string;
  automationDryRunIdentity: string;
  dryRunScenarioGroups: string[];
  simulatedActionSummary: string;
  approvalGateChecklist: string[];
  deniedAutomationActions: string[];
  connectorProviderBoundaryNotes: string[];
  blockedDryRunRisks: string[];
  approvalQueueRoute: string;
  scheduleSafetyRoute: string;
  nextRecommendedAction: string;
  status: AutomationDryRunTrialReviewStatus;
  advancedDryRunDetails: string;
};

export type AutomationDryRunTrialReviewBoundary = {
...
export type AutomationDryRunTrialReviewModel = {
  title: "Automation dry-run trial review";
  summary: string;
  trials: AutomationDryRunTrialReview[];
  boundary: AutomationDryRunTrialReviewBoundary;
  dryRunLanguage: string[];
  advancedDetails: string[];
};

export function buildAutomationDryRunTrialReviewStableKey(
