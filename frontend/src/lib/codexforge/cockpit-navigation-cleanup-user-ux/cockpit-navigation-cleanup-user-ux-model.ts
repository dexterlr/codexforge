...
const COCKPIT_SUMMARY: readonly CockpitNavigationCleanupItem[] = [
  {
    ...
    detail: "Status summary: through phase 1865 after Paper Strategy Promotion Gate v1.",
    state: "review-only",
  },
  {
