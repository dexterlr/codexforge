...
export function buildDefaultWizardFlows(): WizardFlow[] {
  return [
    ...
    flow("coding-trial", "Coding Trial", "Follow a safe live trial with checklist, example change, validation, result capture, and run history handoff.", "Review trial run", "/code-flow/trial-review", ["/readiness", "/consolidation"]),
