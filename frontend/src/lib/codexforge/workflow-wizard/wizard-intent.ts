...
export function buildDefaultWizardIntents(): WizardIntent[] {
  return [
    ...
    intent("inspect-file", "Inspect files", "Read project files without changing them.", "Clear file context.", "file-inspection", "/files", "/jarvis", "Files", "No file writes", "Open files"),
    ...
    intent("manage-memory", "Manage memory", "Review memory without automatic promotion.", "A memory review path.", "memory-review", "/memory", "/jarvis", "Memory", "Review first", "Review candidates"),
