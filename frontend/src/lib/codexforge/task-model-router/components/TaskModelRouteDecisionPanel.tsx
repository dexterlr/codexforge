...
export function TaskModelRouteDecisionPanel() { return <section style={panel}><h2 style={title}>RouteDecision</h2><p style={copy}>Best for novice, cheap/local first, and escalate if needed. No real provider calls and no secret handling.</p></section>; }
