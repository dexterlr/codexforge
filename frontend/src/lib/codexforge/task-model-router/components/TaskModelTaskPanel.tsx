...
export function TaskModelTaskPanel() { return <section style={panel}><h2 style={title}>Task</h2><p style={copy}>Best for novice, cheap/local first, and escalate if needed. No real provider calls and no secret handling.</p></section>; }
