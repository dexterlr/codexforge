...
export function TaskModelRouterSafetyStrip() { return <section style={panel}><h2 style={title}> routerSafety safety</h2><p style={copy}>Best for novice, cheap/local first, and escalate if needed. No real provider calls and no secret handling.</p></section>; }
