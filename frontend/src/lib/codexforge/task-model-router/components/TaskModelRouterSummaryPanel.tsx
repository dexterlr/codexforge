...
export function TaskModelRouterSummaryPanel() { return <section style={panel}><h2 style={title}> routerSummary</h2><p style={copy}>Best for novice, cheap/local first, and escalate if needed. No real provider calls and no secret handling.</p></section>; }
