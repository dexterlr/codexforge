      ...
      <section style={hero}>
        <div style={heroCopy}>
          ...
          <p style={lede}>
            ...
            Cross-link to Video Render Job Preview for image sequence / video frames plan, Creative Execution Sandbox for lifecycle simulation, Creative Readiness for audit-only real executor readiness, or Unreal Adapter Preview for texture/concept-art workflow planning.
          </p>
          <div style={actions}>
