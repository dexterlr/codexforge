    ...
    >
      <PreviewFoundationHero
        ...
        links={[
          ...
          { href: "/live-trial-failure-recovery-review", label: "Live recovery" },
        ]}
      />
      <PreviewFoundationSafetyStrip items={model.recoveryLanguage} />
      <PreviewFoundationCard title="Plain-English unified live workflow trial 2 failure recovery">
        <PreviewFoundationCopy>{model.summary}</PreviewFoundationCopy>
        <PreviewFoundationCopy>
          This page reviews trial 2 failure recovery identity, failure categories, recovery action groups, rollback
          checklist, escalation checklist, denied recovery shortcuts, blocked recovery risks, hardening pass route, beta
          daily workflow route, and next recommended action. It does not trigger recovery, execute workflows, mutate
          files, apply patches, call providers, call local models, call connectors, create automations, or persist
          approvals.
        </PreviewFoundationCopy>
      </PreviewFoundationCard>
      <section id="unified-live-workflow-trial-2-failure-recovery" style={previewStyles.grid}>
        {model.reviews.map((review) => (
          <PreviewFoundationCard
            key={buildUnifiedLiveWorkflowTrialTwoFailureRecoveryStableKey("unified-trial-2-recovery-card", review.id)}
            title={review.trialTwoFailureRecoveryIdentity}
          >
            <PreviewFoundationPillList
              items={[
      ...
      <PreviewFoundationDetail summary="Advanced recovery details">
        ...
        <PreviewFoundationCopy>
          Advanced recovery details stay collapsed or secondary. Trial 2 failure recovery remains separate from recovery
          triggers, workflow execution, live replay, rollback execution, patch application, provider calls, local model
          calls, connector calls, automation execution, file mutation, memory mutation, tools, agents, plugins, and MCP
          runtimes.
        </PreviewFoundationCopy>
      </PreviewFoundationDetail>
    </div>
