...
const SURFACES: readonly Omit<CodexForgeSurfaceItem, "id">[] = [
  ...
  { route: "/files", label: "Files", group: "Engineering Workflow", role: "primary", keepVisible: true, consolidationTarget: "File workflow", readiness: "needs-review", safetyPosture: "read-only project files next", recommendedOperatorUse: "Prepare Phase 56 Real Local Project Reader and file workflow." },
