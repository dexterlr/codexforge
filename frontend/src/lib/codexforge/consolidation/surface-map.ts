...
const SURFACES: readonly Omit<CodexForgeSurfaceItem, "id">[] = [
  ...
  { route: "/ai", label: "AI Workspace", group: "Command Deck", role: "primary", keepVisible: true, consolidationTarget: "Command Deck", readiness: "needs-review", safetyPosture: "approval-gated planning", recommendedOperatorUse: "Use for planning and reviewed handoffs after status is understood." },
  ...
  { route: "/files", label: "Project Reader", group: "Engineering Workflow", role: "primary", keepVisible: true, consolidationTarget: "File workflow", readiness: "ready", safetyPosture: "File Reader v1 functional/read-only", recommendedOperatorUse: "Inspect real local project files, then hand off to Phase 57 Real Patch Preview v1." },
  ...
  { route: "/ai#patch-preview", label: "Patch/apply/regression surfaces", group: "Engineering Workflow", role: "secondary", keepVisible: true, consolidationTarget: "Engineering workflow", readiness: "needs-review", safetyPosture: "preview and approval gates", recommendedOperatorUse: "Keep patch preview and apply gates linked, not auto-run." },
