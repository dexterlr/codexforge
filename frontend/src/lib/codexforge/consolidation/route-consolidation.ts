...
const ROUTES: readonly Omit<RouteConsolidationItem, "id">[] = [
  ...
  { route: "/files", label: "Files", classification: "primary route", prominence: "primary", keepRoute: true, targetSurface: "Engineering Workflow", rationale: "Primary route for Phase 56 Real Local Project Reader." },
