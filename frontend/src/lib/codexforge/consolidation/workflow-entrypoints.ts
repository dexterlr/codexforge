...
export function summarizeWorkflowEntrypoints(model: Pick<WorkflowEntrypoints, "items" | "readyCount">): string[] {
  return [
    ...
    "Phase 60 Closed Loop Fix Workflow is the recommended next phase after Validation Runner v1 review; Creative Local Bridge v1 routes through /creative-bridge.",
  ];
}
