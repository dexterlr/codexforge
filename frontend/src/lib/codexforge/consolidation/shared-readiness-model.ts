...
const ITEMS: readonly Omit<SharedReadinessItem, "id">[] = [
  ...
  { label: "Files", sourceRoute: "/files", readinessLevel: "needs-review", blockerCount: 0, warningCount: 1, nextAction: "Prepare real read-only project reader next.", validationCommand: "npm run build", reviewRequired: true, routeHref: "/files" },
