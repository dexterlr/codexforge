...
const SMOKE_ITEMS: readonly Omit<ProductSmokeCoverageItem, "id">[] = [
  ...
  { label: "Real Apply Guard Review", script: "smoke-codexforge-real-apply-guard-review.ps1", status: "covered", smokeScriptExists: true, managedSuiteInclusion: true, duplicateSuiteEntryRisk: false, targetedValidationCommand: "powershell -ExecutionPolicy Bypass -File .\\scripts\\smoke-codexforge-real-apply-guard-review.ps1", upstreamSmokeDependency: "smoke-codexforge-all.ps1", safetyAssertionsPresent: true, mojibakeAssertionsPresent: true, forbiddenDependencyAssertionsPresent: true, missingSmokeGap: "" },
  ...
  { label: "Guarded Creative Executor", script: "smoke-codexforge-guarded-creative-executor.ps1", status: "covered", smokeScriptExists: true, managedSuiteInclusion: true, duplicateSuiteEntryRisk: false, targetedValidationCommand: "powershell -ExecutionPolicy Bypass -File .\\scripts\\smoke-codexforge-guarded-creative-executor.ps1", upstreamSmokeDependency: "smoke-codexforge-all.ps1", safetyAssertionsPresent: true, mojibakeAssertionsPresent: true, forbiddenDependencyAssertionsPresent: true, missingSmokeGap: "" },
  { label: "Creative Execution Sandbox", script: "smoke-codexforge-creative-execution-sandbox.ps1", status: "covered", smokeScriptExists: true, managedSuiteInclusion: true, duplicateSuiteEntryRisk: false, targetedValidationCommand: "powershell -ExecutionPolicy Bypass -File .\\scripts\\smoke-codexforge-creative-execution-sandbox.ps1", upstreamSmokeDependency: "smoke-codexforge-all.ps1", safetyAssertionsPresent: true, mojibakeAssertionsPresent: true, forbiddenDependencyAssertionsPresent: true, missingSmokeGap: "" },
] as const;
