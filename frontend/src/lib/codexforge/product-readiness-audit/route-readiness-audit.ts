...
const ROUTES: readonly RouteDefinition[] = [
  ...
  { route: "/files", label: "Project Reader", surfaceGroup: "Patch/apply workflow surfaces", readiness: "good", smokeCovered: true, shellNavigationCovered: true, commandPaletteCovered: true, safetyCopyPresent: true, mutationRisk: "medium", uxRisk: "low", consolidationCandidate: false, recommendedAction: "File Reader v1 functional/read-only: inspect real local project files, then recommend Patch Preview v1." },
