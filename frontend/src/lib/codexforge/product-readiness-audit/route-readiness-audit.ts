...
const ROUTES: readonly RouteDefinition[] = [
  ...
  { route: "/creative-executor", label: "Guarded Creative Executor", surfaceGroup: "Creative production surfaces", readiness: "good", smokeCovered: true, shellNavigationCovered: true, commandPaletteCovered: true, safetyCopyPresent: true, mutationRisk: "low", uxRisk: "low", consolidationCandidate: false, recommendedAction: "Mark Guarded Creative Executor as dry-run-first/request-ready; next action can recommend Local Bridge Health Check v1 or Creative Execution Sandbox." },
  { route: "/creative-sandbox", label: "Creative Execution Sandbox", surfaceGroup: "Creative production surfaces", readiness: "good", smokeCovered: true, shellNavigationCovered: true, commandPaletteCovered: true, safetyCopyPresent: true, mutationRisk: "low", uxRisk: "low", consolidationCandidate: false, recommendedAction: "Mark Creative Execution Sandbox as simulation-only; next action can recommend Future Guarded Health Probe or Real Creative Executor MVP after review." },
  { route: "/creative-readiness", label: "Real Creative Executor Readiness", surfaceGroup: "Creative production surfaces", readiness: "good", smokeCovered: true, shellNavigationCovered: true, commandPaletteCovered: true, safetyCopyPresent: true, mutationRisk: "low", uxRisk: "low", consolidationCandidate: false, recommendedAction: "Mark Real Creative Executor Readiness Audit as audit-only; next action can recommend Phase 71 Future Guarded Health Probe, not real execution." },
  { route: "/local-bridge-health", label: "Local Bridge Health", surfaceGroup: "Creative production surfaces", readiness: "good", smokeCovered: true, shellNavigationCovered: true, commandPaletteCovered: true, safetyCopyPresent: true, mutationRisk: "low", uxRisk: "low", consolidationCandidate: false, recommendedAction: "Mark Local Bridge Health Check v1 as preview/manual-only; next action can recommend Future Guarded Health Probe or Creative Execution Sandbox." },
