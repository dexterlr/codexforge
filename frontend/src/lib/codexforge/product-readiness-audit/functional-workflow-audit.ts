...
export function summarizeFunctionalWorkflowAudit(audit: Pick<ProductFunctionalWorkflowAudit, "items" | "functionalCount" | "blockedCount">): string[] {
  return [
    ...
    "Approved Patch Apply v1 request-ready can now recommend Phase 59 Validation Runner v1; Validation Runner v1 can recommend Phase 60 Closed Loop Fix Workflow; Creative Local Bridge v1 can recommend Blender Adapter Preview v1, Unreal Adapter Preview v1, then ComfyUI Adapter Preview v1 or a Future Guarded Creative Executor.",
  ];
}
