...
const ACTIONS: readonly ProductReadinessNextAction[] = [
  ...
  { id: "implement-approved-patch-apply", label: "implement approved patch apply", reason: "Patch Preview v1 functional/preview-only can recommend Approved Patch Apply v1.", priority: 80, route: "/stabilization", copyPrompt: "Proceed to Phase 58 Approved Patch Apply v1 only behind explicit approval, Patch Application Gate, dry-run verification, rollback guidance, and validation boundaries. Product Readiness Audit remains read-only." },
  ...
  { id: "phase-55-consolidation-complete", label: "Consolidation Pass complete", reason: "If clean, File Reader v1 functional/read-only and Patch Preview v1 functional/preview-only can recommend Phase 58 Approved Patch Apply v1.", priority: 120, route: "/consolidation", copyPrompt: "Consolidation Pass complete. File Reader v1 functional/read-only and Patch Preview v1 functional/preview-only are available; proceed to Phase 58 Approved Patch Apply v1." },
] as const;
