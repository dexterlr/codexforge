...
const ACTIONS: readonly ProductReadinessNextAction[] = [
  ...
  { id: "make-patch-preview-real", label: "make Patch Preview real", reason: "File Reader v1 can hand off selected file context to Patch Preview v1.", priority: 70, route: "/ai", copyPrompt: "Proceed to Phase 57 Real Patch Preview v1 with preview-only packets and no direct apply-diff, write-file, or run-command from UI." },
  ...
  { id: "phase-55-consolidation-complete", label: "Consolidation Pass complete", reason: "If clean, File Reader v1 functional/read-only can recommend Phase 57 Real Patch Preview v1.", priority: 120, route: "/consolidation", copyPrompt: "Consolidation Pass complete. File Reader v1 functional/read-only is available; proceed to Phase 57 Real Patch Preview v1." },
] as const;
