...
const ACTIONS: readonly ProductReadinessNextAction[] = [
  ...
  { id: "review-video-render-job-preview", label: "review Video Render Job Preview", reason: "Video Render Job Preview v1 is preview-only for render input, timeline, queue, artifacts, approval, policy, and future executor packet review.", priority: 136, route: "/video-render", copyPrompt: "Review Video Render Job Preview v1. Keep it preview-only: no render execution, no Blender execution, no ComfyUI execution, no Unreal execution, no ffmpeg execution, no file writes. Next action can recommend Future Guarded Creative Executor." },
  { id: "review-guarded-creative-executor", label: "review Guarded Creative Executor", reason: "Guarded Creative Executor is dry-run-first/request-ready with execution disabled in Phase 67.", priority: 137, route: "/creative-executor", copyPrompt: "Review Guarded Creative Executor. Keep it dry-run-first/request-ready: no render execution, no command execution, no file writes, no Blender/ComfyUI/Unreal/ffmpeg execution. Next action can recommend Local Bridge Health Check v1 or Creative Execution Sandbox." },
  { id: "review-creative-execution-sandbox", label: "review Creative Execution Sandbox", reason: "Creative Execution Sandbox is simulation-only and verifies fake lifecycle, cancellation, artifact placeholders, logs, and review handoff before future execution.", priority: 138, route: "/creative-sandbox", copyPrompt: "Review Creative Execution Sandbox. Keep it simulation-only: no real execution, no render execution, no command execution, no local HTTP calls, no provider calls, no file writes, no artifact file creation. Next action can recommend Future Guarded Health Probe or Real Creative Executor MVP only after verification." },
  { id: "review-local-bridge-health", label: "review Local Bridge Health", reason: "Local Bridge Health Check v1 is preview/manual-only and identifies missing config before future execution.", priority: 139, route: "/local-bridge-health", copyPrompt: "Review Local Bridge Health Check v1. Keep health checks preview-only/manual-only/future-guarded: no command execution, no local HTTP calls by default, no file writes, no render execution, and no local app launch. Next action can recommend Future Guarded Health Probe or Creative Execution Sandbox." },
  { id: "review-future-guarded-health-probe", label: "review Health Probe", reason: "Future Guarded Health Probe is metadata/manual-first and real probes are disabled by default.", priority: 139.5, route: "/health-probe", copyPrompt: "Review Future Guarded Health Probe. Keep it metadata/manual-first/request-ready: no creative job execution, no render execution, no arbitrary command, no arbitrary endpoint, no file writes, and no automatic persistence. Recommend Real Creative Executor MVP Design only if readiness passes." },
  { id: "review-real-creative-executor-mvp-design", label: "review Creative MVP Design", reason: "Real Creative Executor MVP Design is design-only and chooses the smallest safe first MVP candidate.", priority: 139.7, route: "/creative-mvp", copyPrompt: "Review Real Creative Executor MVP Design. Keep it design-only: no real execution, no render execution, no command execution, no local HTTP calls, no provider calls, no file writes, execution allowed false. Recommend User-Friendly Product Simplification if UX is still too busy." },
  { id: "review-real-creative-executor-readiness", label: "review Creative Readiness", reason: "Real Creative Executor Readiness Audit is audit-only and answers whether any future executor could advance to Phase 71 Future Guarded Health Probe.", priority: 140, route: "/creative-readiness", copyPrompt: "Review Real Creative Executor Readiness Audit. Keep it audit-only: no real execution, no render execution, no command execution, no local HTTP calls, no provider calls, no file writes, execution allowed false. Next action can recommend Phase 71 Future Guarded Health Probe." },
] as const;
