...
const STATES: readonly FriendlyEmptyState[] = [
  { route: "/files", title: "Select a file to inspect it.", body: "Choose a file from the project explorer to preview code and prepare safe context.", primaryActionLabel: "Inspect a file", secondaryActionLabel: "Ask CodexForge", routeSuggestion: "/ai", safetyNote: "Read-only and no file writes." },
