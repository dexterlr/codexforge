  ...
  return [
    buildGuidedWorkflow({
      ...
      steps: [
        ...
        { id: "run-history", label: "Run History", route: "/run-history", description: "Review run history and copy a handoff.", safety: ["Review first"] },
      ...
      routeTargets: ["/code-flow", "/files", "/validation", "/run-history", "/closed-loop"],
    }),
    buildGuidedWorkflow({
