export type AutomationLiveExecutionGuardReviewStatus = "ready-for-review" | "blocked";

export type AutomationLiveExecutionGuardReview = {
  id: string;
  automationLiveExecutionGuardIdentity: string;
  executionGuardGroups: string[];
  approvalGateChecklist: string[];
  scheduleRateLimitChecklist: string[];
  notificationBoundaryChecklist: string[];
  deniedAutomationExecutionActions: string[];
  blockedExecutionRisks: string[];
  automationDryRunReplayRoute: string;
  automationApprovalTrialRoute: string;
  nextRecommendedAction: string;
  status: AutomationLiveExecutionGuardReviewStatus;
  advancedGuardDetails: string;
};

export type AutomationLiveExecutionGuardReviewBoundary = {
...
export type AutomationLiveExecutionGuardReviewModel = {
  title: "Automation live execution guard review";
  summary: string;
  reviews: AutomationLiveExecutionGuardReview[];
  boundary: AutomationLiveExecutionGuardReviewBoundary;
  guardLanguage: string[];
  advancedDetails: string[];
};

export function buildAutomationLiveExecutionGuardReviewStableKey(
