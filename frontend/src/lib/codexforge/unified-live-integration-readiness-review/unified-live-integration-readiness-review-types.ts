export type UnifiedLiveIntegrationReadinessReviewStatus = "ready-for-review" | "blocked";

export type UnifiedLiveIntegrationReadinessReview = {
  id: string;
  unifiedLiveIntegrationIdentity: string;
  providerReadinessStatus: string;
  localModelReadinessStatus: string;
  connectorReadinessStatus: string;
  automationReadinessStatus: string;
  approvalGateChecklist: string[];
  deniedLiveIntegrationActions: string[];
  unresolvedReadinessRisks: string[];
  firstEndToEndDryRunRoute: string;
  approvalFlowRoute: string;
  nextRecommendedAction: string;
  status: UnifiedLiveIntegrationReadinessReviewStatus;
  advancedReadinessDetails: string;
};

export type UnifiedLiveIntegrationReadinessReviewBoundary = {
...
export type UnifiedLiveIntegrationReadinessReviewModel = {
  title: "Unified live integration readiness review";
  summary: string;
  readinessReviews: UnifiedLiveIntegrationReadinessReview[];
  boundary: UnifiedLiveIntegrationReadinessReviewBoundary;
  readinessLanguage: string[];
  advancedDetails: string[];
};

export function buildUnifiedLiveIntegrationReadinessReviewStableKey(
