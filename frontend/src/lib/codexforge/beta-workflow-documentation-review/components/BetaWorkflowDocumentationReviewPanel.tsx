...
export function BetaWorkflowDocumentationReviewPanel() {
  ...
  return (
    ...
    >
      ...
      <PreviewFoundationCard title="Plain-English beta workflow documentation review">
        <PreviewFoundationCopy>{model.summary}</PreviewFoundationCopy>
        <PreviewFoundationCopy>
          This page reviews beta workflow documentation identity, documentation groups, operator runbook checklist,
          checkpoint doc checklist, safety wording checklist, denied documentation shortcuts, unresolved documentation
          blockers, onboarding final pass route, Beta 2 release candidate route, and next recommended action. It does
          not publish documentation automatically, mutate files from UI, or claim CI passed.
        </PreviewFoundationCopy>
      </PreviewFoundationCard>
      <section id="beta-workflow-documentation-review" style={previewStyles.grid}>
        {model.reviews.map((review) => (
          <PreviewFoundationCard
            key={buildBetaWorkflowDocumentationReviewStableKey("beta-documentation-card", review.id)}
            title={review.betaWorkflowDocumentationIdentity}
          >
            <PreviewFoundationPillList
              items={[
                ...
                `Checkpoint doc checklist: ${review.checkpointDocChecklist.join("; ")}`,
                ...
                review.betaTwoReleaseCandidateRoute,
      ...
      <PreviewFoundationDetail summary="Advanced documentation details">
        ...
        <PreviewFoundationPillList items={model.reviews.map((review) => review.advancedDocumentationDetails)} />
        <PreviewFoundationCopy>
          Advanced documentation details stay collapsed or secondary. This route never publishes documentation,
          applies onboarding changes, writes files, exports runbooks, claims CI passed, runs tests, or mutates memory.
        </PreviewFoundationCopy>
      </PreviewFoundationDetail>
    </div>
  );
