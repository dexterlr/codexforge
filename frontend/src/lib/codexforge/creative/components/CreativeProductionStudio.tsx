  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={statusPill}>Video Render Job Preview render queue preview</span>
...
const page: CSSProperties = { minHeight: 0, background: "transparent", color: "#f8fafc", padding: 0, display: "grid", gap: 16, minWidth: 0, maxWidth: "100%" };
...
const runLink: CSSProperties = { width: "fit-content", maxWidth: "100%", border: "1px solid rgba(125,211,252,0.22)", background: "rgba(14,165,233,0.12)", borderRadius: 8, padding: "8px 10px", color: "#e0f2fe", fontSize: 12, fontWeight: 900, textTransform: "uppercase", textDecoration: "none", overflowWrap: "anywhere" };
const statusGrid: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 150px), 1fr))", gap: 8 };
const statusPill: CSSProperties = { border: "1px solid rgba(148,163,184,0.2)", background: "rgba(2,6,23,0.58)", borderRadius: 8, padding: "9px 10px", color: "#dbeafe", fontSize: 12, fontWeight: 800, textTransform: "uppercase", textAlign: "center", minWidth: 0, maxWidth: "100%", overflowWrap: "anywhere" };
