...
export function buildMissionActivityTimeline(): MissionActivityTimeline {
  const items = [
    ...
    buildMissionActivityItem("reviewed-task-activation-added", "Reviewed Task Activation added", "Phase 23", "Accepted suggestions can become reviewed active plan previews and visible copy-only Jarvis handoffs.", "needs-review"),
