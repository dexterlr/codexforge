...
export function buildMissionSurfaceRegistry(): MissionSurfaceRegistry {
  const surfaces: MissionSurface[] = [
    ...
    buildMissionSurface({
      ...
      href: "/files",
      status: "online",
      role: "Real Local Project Reader readiness for file tree, read-only file preview, metadata, purpose, risk, deterministic search, and Safe Patch Preview handoff.",
      riskPosture: "readonly",
      nextAction: "Inspect project files.",
      readiness: "ready",
      relatedPhase: "Phase 56 Real Local Project Reader",
    }),
    buildMissionSurface({
      id: "capabilities",
      label: "Capabilities",
