...
const ROUTE_DEFINITIONS: Record<OperatorHomeRoutePath, RouteDefinition> = {
  ...
  "/jarvis": {
    ...
    description:
      "Canonical server-owned workspace for conversation, reviewed task intake, explicit approvals, execution progress, results, and audit.",
    domain: "engineering",
    readiness: "ready",
    riskPosture: "approval-required",
    nextAction: "Open Jarvis for the canonical reviewed conversation and task workflow.",
    badge: "Jarvis",
    requiredReview: true,
  },
  "/ai-router": {
