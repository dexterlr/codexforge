import {
  ...
  type JarvisVideoDryRunWorkspaceReviewCard,
} from "./jarvis-video-dry-run-workspace-request";

export const JARVIS_VIDEO_DRY_RUN_WORKSPACE_GUARD_CARDS = [
  {
    id: "cost-guard",
    group: "Guards",
    label: "Cost guard",
    marker: "cost guard review only",
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.costGuardPosture,
    summary:
  ...
  },
  {
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.rateGuardPosture,
    summary:
  ...
  },
  {
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.timeoutGuardPosture,
    summary:
  ...
  },
  {
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.durationGuardPosture,
    summary:
      "Video duration remains static planning metadata only with no render execution and no live video generation.",
    detail: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.durationGuardPreview,
  },
  {
    id: "resolution-guard",
    group: "Guards",
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.resolutionGuardPosture,
    summary:
      "Resolution stays a review-only cap with no provider execution, render execution, or export execution.",
    detail: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.resolutionGuardPreview,
  },
  {
    id: "size-guard",
    group: "Guards",
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.sizeGuardPosture,
    summary:
      "Size stays a review-only cap with no file export, download generation, archive creation, or media upload.",
    detail: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.sizeGuardPreview,
  },
  {
    id: "privacy-guard",
    group: "Guards",
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.privacyGuardPosture,
    summary:
  ...
  },
  {
    ...
    posture: JARVIS_VIDEO_DRY_RUN_WORKSPACE_SHARED_RECORD.safetyGuardPosture,
    summary:
