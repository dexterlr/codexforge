export type FirstAutomationLiveDryRunReplayStatus = "ready-for-review" | "blocked";

export type FirstAutomationLiveDryRunReplay = {
  id: string;
  automationLiveDryRunReplayIdentity: string;
  replayStages: string[];
  expectedActualAutomationComparisonGroups: string[];
  approvalReadinessChecklist: string[];
  ...
  status: FirstAutomationLiveDryRunReplayStatus;
  advancedReplayDetails: string;
};

export type FirstAutomationLiveDryRunReplayBoundary = {
...
export type FirstAutomationLiveDryRunReplayModel = {
  title: "First automation live dry-run replay";
  summary: string;
  replays: FirstAutomationLiveDryRunReplay[];
  boundary: FirstAutomationLiveDryRunReplayBoundary;
  replayLanguage: string[];
  advancedDetails: string[];
};

export function buildFirstAutomationLiveDryRunReplayStableKey(
