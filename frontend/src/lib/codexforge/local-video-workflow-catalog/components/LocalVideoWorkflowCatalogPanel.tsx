...
export function LocalVideoWorkflowCatalogPanel() {
  ...
  // Historical source markers: <h1 style={headline}>Workflows</h1>; Plan local video drafts before spending cloud credits.
