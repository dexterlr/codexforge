...
const PROVIDER_DRY_RUN_AUDIT_APPROVAL_JOIN_MARKERS = [
  "Athena can now review the backend-owned minimal manual-gated provider adapter dry-run audit and approval join MVP",
  ...
  "no database writes",
  "no file writes",
  "current readiness: minimal-provider-dry-run-audit-approval-join-mvp-only / backend-only / dry-run-fixture-only / credential-reference-only / in-memory-only / not-live-provider-executing / not persistent",
