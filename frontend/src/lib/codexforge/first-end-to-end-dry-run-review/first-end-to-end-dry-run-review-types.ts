export type FirstEndToEndDryRunReviewStatus = "ready-for-review" | "blocked";

export type FirstEndToEndDryRunReview = {
  id: string;
  endToEndDryRunIdentity: string;
  dryRunWorkflowStages: string[];
  providerLocalConnectorAutomationHandoffSummary: string[];
  simulatedOutputReviewChecklist: string[];
  deniedExecutionActions: string[];
  safetyValidationChecklist: string[];
  blockedDryRunRisks: string[];
  approvalFlowRoute: string;
  liveIntegrationReleaseCandidateRoute: string;
  nextRecommendedAction: string;
  status: FirstEndToEndDryRunReviewStatus;
  advancedDryRunDetails: string;
};

export type FirstEndToEndDryRunReviewBoundary = {
...
export type FirstEndToEndDryRunReviewModel = {
  title: "First end-to-end dry run review";
  summary: string;
  dryRuns: FirstEndToEndDryRunReview[];
  boundary: FirstEndToEndDryRunReviewBoundary;
  dryRunLanguage: string[];
  advancedDetails: string[];
};

export function buildFirstEndToEndDryRunReviewStableKey(
