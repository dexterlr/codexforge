export type ProviderPermissionPresetsStatus = "ready-for-review" | "blocked";

export type ProviderPermissionPresets = {
  id: string;
  providerPermissionPresetIdentity: string;
  presetGroups: string[];
  providerCapabilityBoundaries: string[];
  deniedPermissionShortcuts: string[];
  approvalGateChecklist: string[];
  privacyAndCredentialNotes: string[];
  blockedPresetRisks: string[];
  auditTrailRoute: string;
  hardeningPassRoute: string;
  nextRecommendedAction: string;
  status: ProviderPermissionPresetsStatus;
  advancedPermissionDetails: string;
};

export type ProviderPermissionPresetsBoundary = {
...
export type ProviderPermissionPresetsModel = {
  title: "Provider permission presets";
  summary: string;
  presets: ProviderPermissionPresets[];
  boundary: ProviderPermissionPresetsBoundary;
  permissionLanguage: string[];
  advancedDetails: string[];
};

export function buildProviderPermissionPresetsStableKey(
