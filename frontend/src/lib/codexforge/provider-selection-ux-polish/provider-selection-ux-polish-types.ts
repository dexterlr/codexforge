export type ProviderSelectionUxPolishStatus = "ready-for-review" | "blocked";

export type ProviderSelectionUxPolish = {
  id: string;
  providerSelectionIdentity: string;
  providerChoiceGroups: string[];
  providerCapabilityLabels: string[];
  recommendedUseHints: string[];
  deniedSelectionActions: string[];
  selectionSafetyChecklist: string[];
  blockedSelectionRisks: string[];
  permissionPresetsRoute: string;
  auditTrailRoute: string;
  nextRecommendedAction: string;
  status: ProviderSelectionUxPolishStatus;
  advancedSelectionDetails: string;
};

export type ProviderSelectionUxPolishBoundary = {
...
export type ProviderSelectionUxPolishModel = {
  title: "Provider selection UX polish";
  summary: string;
  selections: ProviderSelectionUxPolish[];
  boundary: ProviderSelectionUxPolishBoundary;
  selectionLanguage: string[];
  advancedDetails: string[];
};

export function buildProviderSelectionUxPolishStableKey(
