      ...
      <div style={shell} data-codexforge-brain-continuity-dashboard="BrainContinuityDashboard renders read-only no graph mutation no snapshot restore no appendEvent no saveBrainGraph from UI preserve latest-message authority no auto-persistence">
        <section style={hero}>
          <div style={{ display: "grid", gap: 10, minWidth: 0 }}>
            ...
            <div style={links}>
              <Link href="/memory-inbox" style={link}>Memory Inbox</Link>
              <Link href="/runtime-journal" style={link}>Runtime Journal</Link>
...
const hero: CSSProperties = { border: "1px solid rgba(45,212,191,0.2)", background: "linear-gradient(135deg, rgba(3,7,18,0.96), rgba(12,20,32,0.86))", borderRadius: 8, padding: 20, display: "grid", gridTemplateColumns: "minmax(0, 1.15fr) minmax(min(100%, 420px), 0.85fr)", gap: 18, alignItems: "center", minWidth: 0 };
