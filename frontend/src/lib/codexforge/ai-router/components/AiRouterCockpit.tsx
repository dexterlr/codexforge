      ...
      <section style={hero}>
        <div style={{ minWidth: 0 }}>
          ...
          <p style={lede}>
            ...
            reasoning, video render planning, draft render queue planning, and render review. Use local or cheap routing
            for draft planning and draft render queue planning, premium only for complex cinematic/blueprint reasoning,
            and premium only for complex cross-pipeline planning.
          </p>
        </div>
