...
- The future single-page CodexForge Cockpit should show goal, plan, command, approval, execution state, evidence, result, and recovery in one place; phase pages remain dev/test surfaces only.
