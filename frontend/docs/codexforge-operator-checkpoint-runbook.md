...
Current checkpoint note: through phase 2009 with the latest completed batch recorded as 1994-2009 - Video Review And Export Boundary v1 and latest release candidate recorded as Controlled Video Review And Export Boundary Release Candidate. The cockpit now includes safe video review and export boundary previews below Render Job Boundary inside Creative Workspace. Video review and export remains review-only and synthetic data only. Frontend export, download, upload, publishing, scheduling, rendering, render queue creation, worker dispatch, artifact creation, artifact persistence, export persistence, revision persistence, approval persistence, caption persistence, transcript persistence, audio persistence, asset persistence, rights persistence, prompt persistence, job persistence, provider calls, model calls, connector calls, prompt sending, and file mutation remain blocked. Backend-owned export, render, artifact, publish, approval, rights, caption, asset, revision, and job workflows remain required, with operator review and explicit operator approval still required. Trading workspace remains review-only and no-live-transition. Next likely batch: 2010-2025 - Controlled Video Creation Workspace Release Candidate v1.
