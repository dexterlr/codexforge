...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2645 Asset Storage Token Isolation Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-token-isolation-wiring.ps1" `
  -Route "asset-storage-token-isolation-wiring" `
  -CommandLabel "Go to Asset Storage Token Isolation Wiring" `
  -RouteHref "/asset-storage-token-isolation-wiring" `
  -Phase "2645" `
