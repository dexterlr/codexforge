...
$domain = "src\lib\codexforge\connector-live-permission-trial-review"
$route = "src\app\connector-live-permission-trial-review"
$newRoutes = @(
...
& (Join-Path $PSScriptRoot "codexforge-local-project-knowledge-smoke-helper.ps1") `
  -PhaseName "Phase 434 Connector Live Permission Trial Review" `
  -ScriptFile "smoke-codexforge-connector-live-permission-trial-review.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "ConnectorLivePermissionTrialReviewPanel" `
  -CommandLabel "Go to Connector Live Permission Trial Review" `
  -Modules @("connector-live-permission-trial-review-types.ts","connector-live-permission-trial-review-summary.ts","index.ts") `
  -Components @("ConnectorLivePermissionTrialReviewPanel.tsx","index.ts") `
  -Exports @("buildConnectorLivePermissionTrialReviewStableKey","buildConnectorLivePermissionTrialReview","buildConnectorLivePermissionTrialReviews","buildConnectorLivePermissionTrialReviewBoundary","buildConnectorLivePermissionTrialReviewModel","summarizeConnectorLivePermissionTrialReview","CONNECTOR_LIVE_PERMISSION_TRIAL_REVIEW_LANGUAGE") `
  -PhaseMarkers $phaseMarkers `
  -PlainEnglish @(@("connector live permission trial identity","approval gate checklist","denied connector actions","privacy boundary notes","blocked permission trial risks","data redaction route","evidence handoff route","next recommended action") + $connectorReadinessSafetyMarkers) `
  -ExtraRoutes @("/connector-data-redaction-trial-review","/connector-evidence-handoff-review","/connector-permission-readiness-audit","/connector-workspace")
...
Write-Host "[OK] CodexForge Connector Live Permission Trial Review smoke passed."
