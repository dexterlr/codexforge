...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2746 Worker Orchestration Token Isolation Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-token-isolation-wiring.ps1" `
  -Route "worker-orchestration-token-isolation-wiring" `
  -CommandLabel "Go to Worker Orchestration Token Isolation Wiring" `
  -RouteHref "/worker-orchestration-token-isolation-wiring" `
  -Phase "2746" `
