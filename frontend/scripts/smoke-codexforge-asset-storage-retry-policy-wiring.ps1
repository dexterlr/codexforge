...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2653 Asset Storage Retry Policy Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-retry-policy-wiring.ps1" `
  -Route "asset-storage-retry-policy-wiring" `
  -CommandLabel "Go to Asset Storage Retry Policy Wiring" `
  -RouteHref "/asset-storage-retry-policy-wiring" `
  -Phase "2653" `
