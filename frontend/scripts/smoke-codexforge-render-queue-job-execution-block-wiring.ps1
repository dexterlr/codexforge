...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2709 Render Queue Job Execution Block Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-job-execution-block-wiring.ps1" `
  -Route "render-queue-job-execution-block-wiring" `
  -CommandLabel "Go to Render Queue Job Execution Block Wiring" `
  -RouteHref "/render-queue-job-execution-block-wiring" `
  -Phase "2709" `
