...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2626 Provider Gateway Protected Action Matrix Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-protected-action-matrix-hardening.ps1" `
  -Route "provider-gateway-protected-action-matrix-hardening" `
  -CommandLabel "Go to Provider Gateway Protected Action Matrix Hardening" `
  -RouteHref "/provider-gateway-protected-action-matrix-hardening" `
  -Phase "2626" `
