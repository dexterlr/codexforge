...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\tiny-real-controlled-trial", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static tiny real controlled trial smoke passed."
