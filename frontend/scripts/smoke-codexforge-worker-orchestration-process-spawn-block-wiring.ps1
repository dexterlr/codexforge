...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2740 Worker Orchestration Process Spawn Block Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-process-spawn-block-wiring.ps1" `
  -Route "worker-orchestration-process-spawn-block-wiring" `
  -CommandLabel "Go to Worker Orchestration Process Spawn Block Wiring" `
  -RouteHref "/worker-orchestration-process-spawn-block-wiring" `
  -Phase "2740" `
