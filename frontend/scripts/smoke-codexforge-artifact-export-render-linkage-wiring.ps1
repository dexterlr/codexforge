...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2771 Artifact Export Render Linkage Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-render-linkage-wiring.ps1" `
  -Route "artifact-export-render-linkage-wiring" `
  -CommandLabel "Go to Artifact Export Render Linkage Wiring" `
  -RouteHref "/artifact-export-render-linkage-wiring" `
  -Phase "2771" `
  -Title "Artifact Export Render Linkage Wiring" `
  -Markers @(
