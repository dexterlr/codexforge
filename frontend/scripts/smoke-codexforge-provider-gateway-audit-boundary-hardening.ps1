...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2605 Provider Gateway Audit Boundary Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-audit-boundary-hardening.ps1" `
  -Route "provider-gateway-audit-boundary-hardening" `
  -CommandLabel "Go to Provider Gateway Audit Boundary Hardening" `
  -RouteHref "/provider-gateway-audit-boundary-hardening" `
  -Phase "2605" `
