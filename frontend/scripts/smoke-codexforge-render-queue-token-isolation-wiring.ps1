...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2714 Render Queue Token Isolation Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-token-isolation-wiring.ps1" `
  -Route "render-queue-token-isolation-wiring" `
  -CommandLabel "Go to Render Queue Token Isolation Wiring" `
  -RouteHref "/render-queue-token-isolation-wiring" `
  -Phase "2714" `
