...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2602 Provider Gateway Request Envelope Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-request-envelope-hardening.ps1" `
  -Route "provider-gateway-request-envelope-hardening" `
  -CommandLabel "Go to Provider Gateway Request Envelope Hardening" `
  -RouteHref "/provider-gateway-request-envelope-hardening" `
  -Phase "2602" `
