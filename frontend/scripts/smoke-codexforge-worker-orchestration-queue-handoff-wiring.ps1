...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2736 Worker Orchestration Queue Handoff Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-queue-handoff-wiring.ps1" `
  -Route "worker-orchestration-queue-handoff-wiring" `
  -CommandLabel "Go to Worker Orchestration Queue Handoff Wiring" `
  -RouteHref "/worker-orchestration-queue-handoff-wiring" `
  -Phase "2736" `
