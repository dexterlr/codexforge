...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2658 Asset Storage Safety Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-safety-guard-wiring.ps1" `
  -Route "asset-storage-safety-guard-wiring" `
  -CommandLabel "Go to Asset Storage Safety Guard Wiring" `
  -RouteHref "/asset-storage-safety-guard-wiring" `
  -Phase "2658" `
