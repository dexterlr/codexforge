...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2613 Provider Gateway Cost Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-cost-guard-hardening.ps1" `
  -Route "provider-gateway-cost-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Cost Guard Hardening" `
  -RouteHref "/provider-gateway-cost-guard-hardening" `
  -Phase "2613" `
