...
Assert-True ($aggregateEntries.Count -eq 72) "Aggregate executable count is 72"
Assert-True (($aggregateEntries | Where-Object Required).Count -eq 69) "Aggregate required count is 69"
