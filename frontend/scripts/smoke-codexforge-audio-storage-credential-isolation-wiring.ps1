...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2682 Audio Storage Credential Isolation Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-credential-isolation-wiring.ps1" `
  -Route "audio-storage-credential-isolation-wiring" `
  -CommandLabel "Go to Audio Storage Credential Isolation Wiring" `
  -RouteHref "/audio-storage-credential-isolation-wiring" `
  -Phase "2682" `
