...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2698 Render Queue Intake Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-intake-boundary-wiring.ps1" `
  -Route "render-queue-intake-boundary-wiring" `
  -CommandLabel "Go to Render Queue Intake Boundary Wiring" `
  -RouteHref "/render-queue-intake-boundary-wiring" `
  -Phase "2698" `
