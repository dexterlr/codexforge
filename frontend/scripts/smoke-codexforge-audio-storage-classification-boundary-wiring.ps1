...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2670 Audio Storage Classification Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-classification-boundary-wiring.ps1" `
  -Route "audio-storage-classification-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Classification Boundary Wiring" `
  -RouteHref "/audio-storage-classification-boundary-wiring" `
  -Phase "2670" `
