...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2643 Asset Storage Persistence Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-persistence-guard-wiring.ps1" `
  -Route "asset-storage-persistence-guard-wiring" `
  -CommandLabel "Go to Asset Storage Persistence Guard Wiring" `
  -RouteHref "/asset-storage-persistence-guard-wiring" `
  -Phase "2643" `
