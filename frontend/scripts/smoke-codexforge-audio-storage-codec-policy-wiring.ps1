...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2671 Audio Storage Codec Policy Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-codec-policy-wiring.ps1" `
  -Route "audio-storage-codec-policy-wiring" `
  -CommandLabel "Go to Audio Storage Codec Policy Wiring" `
  -RouteHref "/audio-storage-codec-policy-wiring" `
  -Phase "2671" `
