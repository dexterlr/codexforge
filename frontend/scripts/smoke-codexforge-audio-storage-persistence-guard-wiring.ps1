...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2678 Audio Storage Persistence Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-persistence-guard-wiring.ps1" `
  -Route "audio-storage-persistence-guard-wiring" `
  -CommandLabel "Go to Audio Storage Persistence Guard Wiring" `
  -RouteHref "/audio-storage-persistence-guard-wiring" `
  -Phase "2678" `
