...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2766 Artifact Export Format Policy Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-format-policy-wiring.ps1" `
  -Route "artifact-export-format-policy-wiring" `
  -CommandLabel "Go to Artifact Export Format Policy Wiring" `
  -RouteHref "/artifact-export-format-policy-wiring" `
  -Phase "2766" `
  -Title "Artifact Export Format Policy Wiring" `
  -Markers @(
