...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2632 Provider Gateway Cockpit Alignment Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-cockpit-alignment-hardening.ps1" `
  -Route "provider-gateway-cockpit-alignment-hardening" `
  -CommandLabel "Go to Provider Gateway Cockpit Alignment Hardening" `
  -RouteHref "/provider-gateway-cockpit-alignment-hardening" `
  -Phase "2632" `
