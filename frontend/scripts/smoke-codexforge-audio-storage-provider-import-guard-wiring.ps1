...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2684 Audio Storage Provider Import Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-provider-import-guard-wiring.ps1" `
  -Route "audio-storage-provider-import-guard-wiring" `
  -CommandLabel "Go to Audio Storage Provider Import Guard Wiring" `
  -RouteHref "/audio-storage-provider-import-guard-wiring" `
  -Phase "2684" `
