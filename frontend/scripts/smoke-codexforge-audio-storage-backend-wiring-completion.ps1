...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2697 Audio Storage Backend Wiring Completion" `
  -ScriptFile "smoke-codexforge-audio-storage-backend-wiring-completion.ps1" `
  -Route "audio-storage-backend-wiring-completion" `
  -CommandLabel "Go to Audio Storage Backend Wiring Completion" `
  -RouteHref "/audio-storage-backend-wiring-completion" `
  -Phase "2697" `
