...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2650 Asset Storage Approval Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-approval-boundary-wiring.ps1" `
  -Route "asset-storage-approval-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Approval Boundary Wiring" `
  -RouteHref "/asset-storage-approval-boundary-wiring" `
  -Phase "2650" `
