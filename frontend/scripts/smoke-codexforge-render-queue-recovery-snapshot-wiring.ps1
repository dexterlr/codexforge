...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2727 Render Queue Recovery Snapshot Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-recovery-snapshot-wiring.ps1" `
  -Route "render-queue-recovery-snapshot-wiring" `
  -CommandLabel "Go to Render Queue Recovery Snapshot Wiring" `
  -RouteHref "/render-queue-recovery-snapshot-wiring" `
  -Phase "2727" `
