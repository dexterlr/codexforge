...
$domain = "src\lib\codexforge\research-loop-real-world-trial-review"
$route = "src\app\research-loop-real-world-trial-review"
$protectedRoutes = @(
...
& (Join-Path $PSScriptRoot "codexforge-local-project-knowledge-smoke-helper.ps1") `
  -PhaseName "Phase 363 Research Loop Real-World Trial Review" `
  -ScriptFile "smoke-codexforge-research-loop-real-world-trial-review.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "ResearchLoopRealWorldTrialReviewPanel" `
  -CommandLabel "Go to Research Loop Real-World Trial Review" `
  -Modules @("research-loop-real-world-trial-review-types.ts","research-loop-real-world-trial-review-summary.ts","index.ts") `
  -Components @("ResearchLoopRealWorldTrialReviewPanel.tsx","index.ts") `
  -Exports @("buildResearchLoopRealWorldTrialReviewStableKey","buildResearchLoopRealWorldTrialReview","buildResearchLoopRealWorldTrialReviews","buildResearchLoopRealWorldTrialReviewBoundary","buildResearchLoopRealWorldTrialReviewModel","summarizeResearchLoopRealWorldTrialReview","RESEARCH_LOOP_REAL_WORLD_TRIAL_REVIEW_LANGUAGE") `
  -PhaseMarkers $phaseMarkers `
  -PlainEnglish @(@("Research trial identity","Source research release candidate","Operator research scenario","Citation/review gates","Freshness boundary","Blocked real actions","Trial outcome notes","Next loop route","advanced research trial details collapsed/secondary") + $sharedRealWorldSafetyMarkers) `
  -ExtraRoutes @("/research-workspace-release-candidate","/research-freshness-recheck-boundary","/evidence-conflict-resolver-review","/connector-loop-real-world-trial-review")
...
Write-Host "[OK] CodexForge Research Loop Real-World Trial Review smoke passed."
