...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2722 Render Queue Fallback Policy Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-fallback-policy-wiring.ps1" `
  -Route "render-queue-fallback-policy-wiring" `
  -CommandLabel "Go to Render Queue Fallback Policy Wiring" `
  -RouteHref "/render-queue-fallback-policy-wiring" `
  -Phase "2722" `
