...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2741 Worker Orchestration Service Creation Block Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-service-creation-block-wiring.ps1" `
  -Route "worker-orchestration-service-creation-block-wiring" `
  -CommandLabel "Go to Worker Orchestration Service Creation Block Wiring" `
  -RouteHref "/worker-orchestration-service-creation-block-wiring" `
  -Phase "2741" `
