...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2733 Worker Orchestration Validation Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-validation-boundary-wiring.ps1" `
  -Route "worker-orchestration-validation-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Validation Boundary Wiring" `
  -RouteHref "/worker-orchestration-validation-boundary-wiring" `
  -Phase "2733" `
