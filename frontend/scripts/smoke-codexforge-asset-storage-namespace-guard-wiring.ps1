...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2640 Asset Storage Namespace Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-namespace-guard-wiring.ps1" `
  -Route "asset-storage-namespace-guard-wiring" `
  -CommandLabel "Go to Asset Storage Namespace Guard Wiring" `
  -RouteHref "/asset-storage-namespace-guard-wiring" `
  -Phase "2640" `
