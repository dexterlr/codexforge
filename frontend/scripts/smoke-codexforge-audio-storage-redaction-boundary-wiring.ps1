...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2688 Audio Storage Redaction Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-redaction-boundary-wiring.ps1" `
  -Route "audio-storage-redaction-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Redaction Boundary Wiring" `
  -RouteHref "/audio-storage-redaction-boundary-wiring" `
  -Phase "2688" `
