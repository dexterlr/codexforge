...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2706 Render Queue Scheduling Policy Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-scheduling-policy-wiring.ps1" `
  -Route "render-queue-scheduling-policy-wiring" `
  -CommandLabel "Go to Render Queue Scheduling Policy Wiring" `
  -RouteHref "/render-queue-scheduling-policy-wiring" `
  -Phase "2706" `
