...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2633 Provider Gateway Hardening Completion" `
  -ScriptFile "smoke-codexforge-provider-gateway-hardening-completion.ps1" `
  -Route "provider-gateway-hardening-completion" `
  -CommandLabel "Go to Provider Gateway Hardening Completion" `
  -RouteHref "/provider-gateway-hardening-completion" `
  -Phase "2633" `
