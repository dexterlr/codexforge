...
$domain = "src\lib\codexforge\live-workflow-evidence-capture-review"
$route = "src\app\live-workflow-evidence-capture-review"
$newRoutes = @(
...
& (Join-Path $PSScriptRoot "codexforge-local-project-knowledge-smoke-helper.ps1") `
  -PhaseName "Phase 450 Live Workflow Evidence Capture Review" `
  -ScriptFile "smoke-codexforge-live-workflow-evidence-capture-review.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "LiveWorkflowEvidenceCaptureReviewPanel" `
  -CommandLabel "Go to Live Workflow Evidence Capture Review" `
  -Modules @("live-workflow-evidence-capture-review-types.ts","live-workflow-evidence-capture-review-summary.ts","index.ts") `
  -Components @("LiveWorkflowEvidenceCaptureReviewPanel.tsx","index.ts") `
  -Exports @("buildLiveWorkflowEvidenceCaptureReviewStableKey","buildLiveWorkflowEvidenceCaptureReview","buildLiveWorkflowEvidenceCaptureReviewReviews","buildLiveWorkflowEvidenceCaptureReviewBoundary","buildLiveWorkflowEvidenceCaptureReviewModel","summarizeLiveWorkflowEvidenceCaptureReview","LIVE_WORKFLOW_EVIDENCE_CAPTURE_REVIEW_LANGUAGE") `
  -PhaseMarkers $phaseMarkers `
  -PlainEnglish $plainEnglish `
  -ExtraRoutes @("/live-workflow-result-review-inbox","/live-workflow-operator-feedback-review","/first-controlled-live-workflow-trial","/codexforge-live-integration-release-candidate")
...
Write-Host "[OK] CodexForge Live workflow evidence capture review smoke passed."
