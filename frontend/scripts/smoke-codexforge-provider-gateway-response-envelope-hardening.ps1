...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2603 Provider Gateway Response Envelope Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-response-envelope-hardening.ps1" `
  -Route "provider-gateway-response-envelope-hardening" `
  -CommandLabel "Go to Provider Gateway Response Envelope Hardening" `
  -RouteHref "/provider-gateway-response-envelope-hardening" `
  -Phase "2603" `
