...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\backend-approval-handoff", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static backend approval handoff smoke passed."
