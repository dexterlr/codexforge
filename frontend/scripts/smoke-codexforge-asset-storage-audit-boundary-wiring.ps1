...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2649 Asset Storage Audit Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-audit-boundary-wiring.ps1" `
  -Route "asset-storage-audit-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Audit Boundary Wiring" `
  -RouteHref "/asset-storage-audit-boundary-wiring" `
  -Phase "2649" `
