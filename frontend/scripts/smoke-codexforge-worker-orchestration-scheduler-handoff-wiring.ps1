...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2737 Worker Orchestration Scheduler Handoff Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-scheduler-handoff-wiring.ps1" `
  -Route "worker-orchestration-scheduler-handoff-wiring" `
  -CommandLabel "Go to Worker Orchestration Scheduler Handoff Wiring" `
  -RouteHref "/worker-orchestration-scheduler-handoff-wiring" `
  -Phase "2737" `
