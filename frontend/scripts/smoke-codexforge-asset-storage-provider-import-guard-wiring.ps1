...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2646 Asset Storage Provider Import Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-provider-import-guard-wiring.ps1" `
  -Route "asset-storage-provider-import-guard-wiring" `
  -CommandLabel "Go to Asset Storage Provider Import Guard Wiring" `
  -RouteHref "/asset-storage-provider-import-guard-wiring" `
  -Phase "2646" `
