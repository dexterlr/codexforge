...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2668 Audio Storage Metadata Envelope Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-metadata-envelope-wiring.ps1" `
  -Route "audio-storage-metadata-envelope-wiring" `
  -CommandLabel "Go to Audio Storage Metadata Envelope Wiring" `
  -RouteHref "/audio-storage-metadata-envelope-wiring" `
  -Phase "2668" `
