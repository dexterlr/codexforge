...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2639 Asset Storage Path Policy Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-path-policy-wiring.ps1" `
  -Route "asset-storage-path-policy-wiring" `
  -CommandLabel "Go to Asset Storage Path Policy Wiring" `
  -RouteHref "/asset-storage-path-policy-wiring" `
  -Phase "2639" `
