...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2642 Asset Storage Download Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-download-block-boundary-wiring.ps1" `
  -Route "asset-storage-download-block-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Download Block Boundary Wiring" `
  -RouteHref "/asset-storage-download-block-boundary-wiring" `
  -Phase "2642" `
