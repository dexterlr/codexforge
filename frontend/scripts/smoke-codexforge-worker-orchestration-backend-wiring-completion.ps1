...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2761 Worker Orchestration Backend Wiring Completion" `
  -ScriptFile "smoke-codexforge-worker-orchestration-backend-wiring-completion.ps1" `
  -Route "worker-orchestration-backend-wiring-completion" `
  -CommandLabel "Go to Worker Orchestration Backend Wiring Completion" `
  -RouteHref "/worker-orchestration-backend-wiring-completion" `
  -Phase "2761" `
