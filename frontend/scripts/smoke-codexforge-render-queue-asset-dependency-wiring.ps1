...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2702 Render Queue Asset Dependency Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-asset-dependency-wiring.ps1" `
  -Route "render-queue-asset-dependency-wiring" `
  -CommandLabel "Go to Render Queue Asset Dependency Wiring" `
  -RouteHref "/render-queue-asset-dependency-wiring" `
  -Phase "2702" `
