...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2664 Asset Storage Cockpit Alignment Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-cockpit-alignment-wiring.ps1" `
  -Route "asset-storage-cockpit-alignment-wiring" `
  -CommandLabel "Go to Asset Storage Cockpit Alignment Wiring" `
  -RouteHref "/asset-storage-cockpit-alignment-wiring" `
  -Phase "2664" `
