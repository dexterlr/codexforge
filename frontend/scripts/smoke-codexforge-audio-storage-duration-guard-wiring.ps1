...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2672 Audio Storage Duration Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-duration-guard-wiring.ps1" `
  -Route "audio-storage-duration-guard-wiring" `
  -CommandLabel "Go to Audio Storage Duration Guard Wiring" `
  -RouteHref "/audio-storage-duration-guard-wiring" `
  -Phase "2672" `
