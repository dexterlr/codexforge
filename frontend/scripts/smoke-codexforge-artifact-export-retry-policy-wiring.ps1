...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2787 Artifact Export Retry Policy Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-retry-policy-wiring.ps1" `
  -Route "artifact-export-retry-policy-wiring" `
  -CommandLabel "Go to Artifact Export Retry Policy Wiring" `
  -RouteHref "/artifact-export-retry-policy-wiring" `
  -Phase "2787" `
  -Title "Artifact Export Retry Policy Wiring" `
  -Markers @(
