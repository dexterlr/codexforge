...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2720 Render Queue Observability Trace Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-observability-trace-wiring.ps1" `
  -Route "render-queue-observability-trace-wiring" `
  -CommandLabel "Go to Render Queue Observability Trace Wiring" `
  -RouteHref "/render-queue-observability-trace-wiring" `
  -Phase "2720" `
