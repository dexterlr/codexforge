...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2789 Artifact Export Rate Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-rate-guard-wiring.ps1" `
  -Route "artifact-export-rate-guard-wiring" `
  -CommandLabel "Go to Artifact Export Rate Guard Wiring" `
  -RouteHref "/artifact-export-rate-guard-wiring" `
  -Phase "2789" `
  -Title "Artifact Export Rate Guard Wiring" `
  -Markers @(
