...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2618 Provider Gateway Prompt Egress Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-prompt-egress-guard-hardening.ps1" `
  -Route "provider-gateway-prompt-egress-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Prompt Egress Guard Hardening" `
  -RouteHref "/provider-gateway-prompt-egress-guard-hardening" `
  -Phase "2618" `
