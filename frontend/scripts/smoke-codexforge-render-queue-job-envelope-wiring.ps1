...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2700 Render Queue Job Envelope Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-job-envelope-wiring.ps1" `
  -Route "render-queue-job-envelope-wiring" `
  -CommandLabel "Go to Render Queue Job Envelope Wiring" `
  -RouteHref "/render-queue-job-envelope-wiring" `
  -Phase "2700" `
