...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2619 Provider Gateway Network Egress Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-network-egress-guard-hardening.ps1" `
  -Route "provider-gateway-network-egress-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Network Egress Guard Hardening" `
  -RouteHref "/provider-gateway-network-egress-guard-hardening" `
  -Phase "2619" `
