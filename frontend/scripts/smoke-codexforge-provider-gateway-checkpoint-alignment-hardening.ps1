...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2630 Provider Gateway Checkpoint Alignment Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-checkpoint-alignment-hardening.ps1" `
  -Route "provider-gateway-checkpoint-alignment-hardening" `
  -CommandLabel "Go to Provider Gateway Checkpoint Alignment Hardening" `
  -RouteHref "/provider-gateway-checkpoint-alignment-hardening" `
  -Phase "2630" `
