...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2638 Asset Storage Classification Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-classification-boundary-wiring.ps1" `
  -Route "asset-storage-classification-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Classification Boundary Wiring" `
  -RouteHref "/asset-storage-classification-boundary-wiring" `
  -Phase "2638" `
