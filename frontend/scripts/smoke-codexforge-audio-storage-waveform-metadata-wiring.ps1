...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2673 Audio Storage Waveform Metadata Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-waveform-metadata-wiring.ps1" `
  -Route "audio-storage-waveform-metadata-wiring" `
  -CommandLabel "Go to Audio Storage Waveform Metadata Wiring" `
  -RouteHref "/audio-storage-waveform-metadata-wiring" `
  -Phase "2673" `
