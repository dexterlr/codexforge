...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2783 Artifact Export Audit Boundary Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-audit-boundary-wiring.ps1" `
  -Route "artifact-export-audit-boundary-wiring" `
  -CommandLabel "Go to Artifact Export Audit Boundary Wiring" `
  -RouteHref "/artifact-export-audit-boundary-wiring" `
  -Phase "2783" `
  -Title "Artifact Export Audit Boundary Wiring" `
  -Markers @(
