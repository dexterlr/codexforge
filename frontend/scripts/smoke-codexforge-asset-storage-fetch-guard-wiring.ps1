...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2648 Asset Storage Fetch Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-fetch-guard-wiring.ps1" `
  -Route "asset-storage-fetch-guard-wiring" `
  -CommandLabel "Go to Asset Storage Fetch Guard Wiring" `
  -RouteHref "/asset-storage-fetch-guard-wiring" `
  -Phase "2648" `
