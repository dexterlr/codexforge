...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2786 Artifact Export Observability Trace Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-observability-trace-wiring.ps1" `
  -Route "artifact-export-observability-trace-wiring" `
  -CommandLabel "Go to Artifact Export Observability Trace Wiring" `
  -RouteHref "/artifact-export-observability-trace-wiring" `
  -Phase "2786" `
  -Title "Artifact Export Observability Trace Wiring" `
  -Markers @(
