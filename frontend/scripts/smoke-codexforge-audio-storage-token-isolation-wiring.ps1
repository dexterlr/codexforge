...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2683 Audio Storage Token Isolation Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-token-isolation-wiring.ps1" `
  -Route "audio-storage-token-isolation-wiring" `
  -CommandLabel "Go to Audio Storage Token Isolation Wiring" `
  -RouteHref "/audio-storage-token-isolation-wiring" `
  -Phase "2683" `
