...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2758 Worker Orchestration Safety Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-safety-guard-wiring.ps1" `
  -Route "worker-orchestration-safety-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Safety Guard Wiring" `
  -RouteHref "/worker-orchestration-safety-guard-wiring" `
  -Phase "2758" `
