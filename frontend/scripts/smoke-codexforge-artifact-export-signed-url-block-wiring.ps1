...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2776 Artifact Export Signed URL Block Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-signed-url-block-wiring.ps1" `
  -Route "artifact-export-signed-url-block-wiring" `
  -CommandLabel "Go to Artifact Export Signed URL Block Wiring" `
  -RouteHref "/artifact-export-signed-url-block-wiring" `
  -Phase "2776" `
  -Title "Artifact Export Signed URL Block Wiring" `
  -Markers @(
