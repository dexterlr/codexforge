...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2661 Asset Storage Operator Review Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-operator-review-wiring.ps1" `
  -Route "asset-storage-operator-review-wiring" `
  -CommandLabel "Go to Asset Storage Operator Review Wiring" `
  -RouteHref "/asset-storage-operator-review-wiring" `
  -Phase "2661" `
