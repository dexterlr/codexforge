...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2703 Render Queue Audio Dependency Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-audio-dependency-wiring.ps1" `
  -Route "render-queue-audio-dependency-wiring" `
  -CommandLabel "Go to Render Queue Audio Dependency Wiring" `
  -RouteHref "/render-queue-audio-dependency-wiring" `
  -Phase "2703" `
