...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2657 Asset Storage Privacy Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-privacy-guard-wiring.ps1" `
  -Route "asset-storage-privacy-guard-wiring" `
  -CommandLabel "Go to Asset Storage Privacy Guard Wiring" `
  -RouteHref "/asset-storage-privacy-guard-wiring" `
  -Phase "2657" `
