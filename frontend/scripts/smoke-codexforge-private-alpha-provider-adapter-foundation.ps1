...
foreach ($requiredToken in @(
  ...
  "resolvedProviderAdapter.getAvailability()",
  "resolvedProviderAdapter.generateApprovedText(",
...
async function main() {
  ...
  assert(
    storeSource.includes("PrivateAlphaProviderAdapter") &&
      ...
      storeSource.includes("resolvedProviderAdapter.getAvailability()") &&
      storeSource.includes("resolvedProviderAdapter.generateApprovedText(") &&
      storeSource.includes("createPrivateAlphaProviderAdapterForModelKey") &&
      storeSource.includes("providerAdapterResolver"),
  ...
  assert(
    JSON.stringify(persistedErrorCodes) ===
      JSON.stringify([...originalOllamaErrorCodes, ...appendedGroqErrorCodes]),
