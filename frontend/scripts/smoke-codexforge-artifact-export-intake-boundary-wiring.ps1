...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2762 Artifact Export Intake Boundary Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-intake-boundary-wiring.ps1" `
  -Route "artifact-export-intake-boundary-wiring" `
  -CommandLabel "Go to Artifact Export Intake Boundary Wiring" `
  -RouteHref "/artifact-export-intake-boundary-wiring" `
  -Phase "2762" `
  -Title "Artifact Export Intake Boundary Wiring" `
  -Markers @(
