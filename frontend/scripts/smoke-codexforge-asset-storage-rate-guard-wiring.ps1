...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2655 Asset Storage Rate Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-rate-guard-wiring.ps1" `
  -Route "asset-storage-rate-guard-wiring" `
  -CommandLabel "Go to Asset Storage Rate Guard Wiring" `
  -RouteHref "/asset-storage-rate-guard-wiring" `
  -Phase "2655" `
