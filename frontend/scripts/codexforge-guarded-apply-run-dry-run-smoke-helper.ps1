...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\guarded-apply-run-dry-run", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static guarded apply/run dry-run packet smoke passed."
