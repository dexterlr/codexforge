...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2616 Provider Gateway Credential Isolation Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-credential-isolation-hardening.ps1" `
  -Route "provider-gateway-credential-isolation-hardening" `
  -CommandLabel "Go to Provider Gateway Credential Isolation Hardening" `
  -RouteHref "/provider-gateway-credential-isolation-hardening" `
  -Phase "2616" `
