...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2752 Worker Orchestration Observability Trace Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-observability-trace-wiring.ps1" `
  -Route "worker-orchestration-observability-trace-wiring" `
  -CommandLabel "Go to Worker Orchestration Observability Trace Wiring" `
  -RouteHref "/worker-orchestration-observability-trace-wiring" `
  -Phase "2752" `
