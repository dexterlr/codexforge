...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2641 Asset Storage Upload Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-upload-block-boundary-wiring.ps1" `
  -Route "asset-storage-upload-block-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Upload Block Boundary Wiring" `
  -RouteHref "/asset-storage-upload-block-boundary-wiring" `
  -Phase "2641" `
