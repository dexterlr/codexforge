...
foreach ($needle in @(
  ...
  "smoke-codexforge-backend-owned-minimal-manual-gated-provider-adapter-dry-run-execution-review-recovery-preview-mega-batch.ps1",
  "Phase 5993 Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution MVP",
  "smoke-codexforge-backend-owned-minimal-manual-gated-provider-adapter-dry-run-execution-mvp-mega-batch.ps1",
  ...
  "smoke-codexforge-backend-owned-minimal-manual-gated-text-model-adapter-audit-approval-join-mvp-mega-batch.ps1",
...
foreach ($needle in @(
  ...
  "Latest completed batch: 6090-6121 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Audit and Approval Join MVP",
  "Previous completed batch: 6058-6089 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Result Capture Review and Recovery Preview",
  "Next likely batch: 6122-6153 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Audit and Approval Join Review and Recovery Preview",
  ...
  "no database writes",
  "no file writes",
  "current readiness is minimal-provider-dry-run-audit-approval-join-mvp-only / backend-only / dry-run-fixture-only / credential-reference-only / in-memory-only / not-live-provider-executing / not persistent",
  ...
  "Previous completed batch: 5994-6025 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution Review and Recovery Preview",
  "Next likely batch: 6058-6089 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Result Capture Review and Recovery Preview",
  ...
  "current readiness is minimal-provider-dry-run-result-capture-mvp-only / backend-only / dry-run-fixture-capture-only / credential-reference-only / not-live-provider-executing / not persistent",
  "backend-owned minimal manual-gated provider adapter dry-run result capture review and recovery preview next",
  "Current checkpoint: Highest detected phase: 6025. Latest completed batch: 5994-6025 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution Review and Recovery Preview. Previous completed batch: 5962-5993 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution MVP. Next likely batch: 6026-6057 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Result Capture MVP.",
  "## Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution Review And Recovery Preview Checkpoint",
  "Highest detected phase: 6025",
  "Latest completed batch: 5994-6025 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution Review and Recovery Preview",
  "Previous completed batch: 5962-5993 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Execution MVP",
  "Next likely batch: 6026-6057 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Result Capture MVP",
  ...
  "current readiness is minimal-provider-dry-run-execution-review-only / backend-only / dry-run-fixture-only / credential-reference-only / not-live-provider-executing / not persistent",
  "acceptance state is not accepted for live provider execution / provider dry-run execution fixture MVP accepted only",
  ...
  "Previous completed batch: 5866-5897 - Backend-Owned Minimal Manual-Gated Provider Adapter Selection and Credential Reference Review and Recovery Preview",
  "Next likely batch: 5930-5961 - Backend-Owned Minimal Manual-Gated Provider Adapter Dry-Run Admission Review and Recovery Preview",
  ...
  "opaque credential references only",
  "no plaintext secrets",
  "current readiness is minimal-provider-dry-run-admission-mvp-only / backend-only / admission-only / credential-reference-only / fixture-only / not-provider-executing / not persistent",
  ...
  "Previous completed batch: 5770-5801 - Backend-Owned Minimal Manual-Gated Text Model Adapter Audit and Approval Join MVP",
  "Next likely batch: 5834-5865 - Backend-Owned Minimal Manual-Gated Provider Adapter Selection and Credential Reference MVP",
  ...
  "current readiness is minimal-text-adapter-audit-approval-join-review-only / backend-only / fixture-only / in-memory-only / not persistent",
  "acceptance state is not accepted for live provider execution / text adapter audit approval join fixture MVP accepted only",
  ...
  "Latest completed batch: 5770-5801 - Backend-Owned Minimal Manual-Gated Text Model Adapter Audit and Approval Join MVP",
  "Previous completed batch: 5738-5769 - Backend-Owned Minimal Manual-Gated Text Model Adapter Result Capture Review and Recovery Preview",
  "Next likely batch: 5802-5833 - Backend-Owned Minimal Manual-Gated Text Model Adapter Audit and Approval Join Review and Recovery Preview",
  ...
  "current readiness is minimal-text-adapter-audit-approval-join-mvp-only / backend-only / fixture-only / in-memory-only / not persistent",
