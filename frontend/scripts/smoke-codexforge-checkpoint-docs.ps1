...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs preserve historical first gated provider trial preparation checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis operator control plane foundation checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis shared backend adapter contract checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis permission approval engine checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis task planner tool router checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis audit result ledger and status dashboard checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis unified workspace shells checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention First Jarvis-Controlled Video Approval Packet Workspace checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention First Jarvis-Controlled Video Dry Run Workspace checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention First Jarvis-Controlled Video Adapter Plug-in checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention first backend-owned video provider execution adapter readiness checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention first backend-owned video provider execution approval packet checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention first backend-owned video provider dry run checkpoint $needle"
}
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention backend-owned video provider execution runtime readiness checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention controlled render artifact publish review trial checkpoint $needle"
}
...
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention Jarvis Video Studio Release Candidate checkpoint $needle"
}
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention First Jarvis-Controlled Video Trial Result Review and Recovery checkpoint $needle"
}
foreach ($needle in @(
  ...
  Assert-Contains $docsCombined $needle "docs mention First Jarvis-Controlled Video Backend Trial Runner Contract checkpoint $needle"
}
foreach ($needle in @(
