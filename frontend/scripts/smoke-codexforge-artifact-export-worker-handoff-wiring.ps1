...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2772 Artifact Export Worker Handoff Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-worker-handoff-wiring.ps1" `
  -Route "artifact-export-worker-handoff-wiring" `
  -CommandLabel "Go to Artifact Export Worker Handoff Wiring" `
  -RouteHref "/artifact-export-worker-handoff-wiring" `
  -Phase "2772" `
  -Title "Artifact Export Worker Handoff Wiring" `
  -Markers @(
