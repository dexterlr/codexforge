...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2791 Artifact Export Privacy Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-privacy-guard-wiring.ps1" `
  -Route "artifact-export-privacy-guard-wiring" `
  -CommandLabel "Go to Artifact Export Privacy Guard Wiring" `
  -RouteHref "/artifact-export-privacy-guard-wiring" `
  -Phase "2791" `
  -Title "Artifact Export Privacy Guard Wiring" `
  -Markers @(
