...
$sourceParts = @()
foreach ($scanRoot in @("src\lib\codexforge\controlled-paper-trading-workspace", $Domain, $Route, (Join-Path "scripts" $ScriptFile))) {
...
Assert-Contains $source "ControlledPaperTradingWorkspaceRoutePanel" "main route panel"
Assert-Contains $source "ControlledPaperTradingWorkspaceCockpitSummaryPanel" "cockpit controlled paper trading workspace summary panel"
Assert-Contains $cockpitPanel "ControlledPaperTradingWorkspaceCockpitSummaryPanel" "cockpit navigation cleanup controlled paper trading workspace summary"
Assert-Contains $unifiedCockpit "ControlledPaperTradingWorkspaceCockpitSummaryPanel" "unified cockpit controlled paper trading workspace summary"
...
Write-Host ("[OK] " + $SmokeName + " static controlled paper trading workspace smoke passed.")
