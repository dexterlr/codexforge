...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2770 Artifact Export Audio Linkage Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-audio-linkage-wiring.ps1" `
  -Route "artifact-export-audio-linkage-wiring" `
  -CommandLabel "Go to Artifact Export Audio Linkage Wiring" `
  -RouteHref "/artifact-export-audio-linkage-wiring" `
  -Phase "2770" `
  -Title "Artifact Export Audio Linkage Wiring" `
  -Markers @(
