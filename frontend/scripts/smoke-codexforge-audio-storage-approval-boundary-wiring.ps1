...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2687 Audio Storage Approval Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-approval-boundary-wiring.ps1" `
  -Route "audio-storage-approval-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Approval Boundary Wiring" `
  -RouteHref "/audio-storage-approval-boundary-wiring" `
  -Phase "2687" `
