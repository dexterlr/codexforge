...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2617 Provider Gateway Token Isolation Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-token-isolation-hardening.ps1" `
  -Route "provider-gateway-token-isolation-hardening" `
  -CommandLabel "Go to Provider Gateway Token Isolation Hardening" `
  -RouteHref "/provider-gateway-token-isolation-hardening" `
  -Phase "2617" `
