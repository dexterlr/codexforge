...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2660 Asset Storage Recovery Snapshot Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-recovery-snapshot-wiring.ps1" `
  -Route "asset-storage-recovery-snapshot-wiring" `
  -CommandLabel "Go to Asset Storage Recovery Snapshot Wiring" `
  -RouteHref "/asset-storage-recovery-snapshot-wiring" `
  -Phase "2660" `
