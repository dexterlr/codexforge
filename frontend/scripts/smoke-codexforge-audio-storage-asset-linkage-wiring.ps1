...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2675 Audio Storage Asset Linkage Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-asset-linkage-wiring.ps1" `
  -Route "audio-storage-asset-linkage-wiring" `
  -CommandLabel "Go to Audio Storage Asset Linkage Wiring" `
  -RouteHref "/audio-storage-asset-linkage-wiring" `
  -Phase "2675" `
