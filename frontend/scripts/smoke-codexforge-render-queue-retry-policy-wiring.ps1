...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2721 Render Queue Retry Policy Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-retry-policy-wiring.ps1" `
  -Route "render-queue-retry-policy-wiring" `
  -CommandLabel "Go to Render Queue Retry Policy Wiring" `
  -RouteHref "/render-queue-retry-policy-wiring" `
  -Phase "2721" `
