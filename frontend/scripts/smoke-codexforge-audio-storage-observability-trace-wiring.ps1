...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2689 Audio Storage Observability Trace Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-observability-trace-wiring.ps1" `
  -Route "audio-storage-observability-trace-wiring" `
  -CommandLabel "Go to Audio Storage Observability Trace Wiring" `
  -RouteHref "/audio-storage-observability-trace-wiring" `
  -Phase "2689" `
