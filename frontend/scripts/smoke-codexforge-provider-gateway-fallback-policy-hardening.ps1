...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2611 Provider Gateway Fallback Policy Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-fallback-policy-hardening.ps1" `
  -Route "provider-gateway-fallback-policy-hardening" `
  -CommandLabel "Go to Provider Gateway Fallback Policy Hardening" `
  -RouteHref "/provider-gateway-fallback-policy-hardening" `
  -Phase "2611" `
