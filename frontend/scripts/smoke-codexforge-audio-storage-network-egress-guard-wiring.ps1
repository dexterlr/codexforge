...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2685 Audio Storage Network Egress Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-network-egress-guard-wiring.ps1" `
  -Route "audio-storage-network-egress-guard-wiring" `
  -CommandLabel "Go to Audio Storage Network Egress Guard Wiring" `
  -RouteHref "/audio-storage-network-egress-guard-wiring" `
  -Phase "2685" `
