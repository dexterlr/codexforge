...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2651 Asset Storage Redaction Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-redaction-boundary-wiring.ps1" `
  -Route "asset-storage-redaction-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Redaction Boundary Wiring" `
  -RouteHref "/asset-storage-redaction-boundary-wiring" `
  -Phase "2651" `
