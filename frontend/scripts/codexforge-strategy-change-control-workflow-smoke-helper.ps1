...
$sourceParts = @()
foreach ($scanRoot in @("src\lib\codexforge\strategy-change-control-workflow", $Domain, $Route, (Join-Path "scripts" $ScriptFile))) {
...
Assert-Contains $source "StrategyChangeControlWorkflowRoutePanel" "main route panel"
Assert-Contains $source "StrategyChangeControlWorkflowCockpitSummaryPanel" "cockpit strategy change control summary panel"
Assert-Contains $cockpitPanel "StrategyChangeControlWorkflowCockpitSummaryPanel" "cockpit navigation cleanup strategy change control summary"
Assert-Contains $unifiedCockpit "StrategyChangeControlWorkflowCockpitSummaryPanel" "unified cockpit strategy change control summary"
...
Write-Host ("[OK] " + $SmokeName + " static strategy change control workflow smoke passed.")
