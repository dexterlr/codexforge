...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2674 Audio Storage Transcript Linkage Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-transcript-linkage-wiring.ps1" `
  -Route "audio-storage-transcript-linkage-wiring" `
  -CommandLabel "Go to Audio Storage Transcript Linkage Wiring" `
  -RouteHref "/audio-storage-transcript-linkage-wiring" `
  -Phase "2674" `
