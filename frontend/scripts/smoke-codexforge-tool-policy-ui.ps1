...
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "export function ToolExecutionResultPanel" "result panel component export"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "data-codexforge-tool-execution-result-panel" "result panel root marker"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "Approval id" "result panel approval id label"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "Policy source" "result panel policy source label"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "Result summary" "result panel summary label"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "Job stage" "result panel job stage label"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "Adapter" "result panel adapter label"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "local-safe-render-job" "result panel local-safe adapter marker"
Assert-Contains "src\lib\codexforge\chat\components\tool-execution-result-panel.tsx" "sideEffect" "result panel sideEffect marker"
Assert-Contains "src\lib\codexforge\chat\components\tool-policy-decision-panel.tsx" "tool-execution-result-panel" "decision panel imports result panel"
Assert-Contains "src\lib\codexforge\chat\components\tool-policy-decision-panel.tsx" "<ToolExecutionResultPanel" "decision panel renders result panel"
