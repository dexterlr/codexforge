...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2782 Artifact Export Network Egress Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-network-egress-guard-wiring.ps1" `
  -Route "artifact-export-network-egress-guard-wiring" `
  -CommandLabel "Go to Artifact Export Network Egress Guard Wiring" `
  -RouteHref "/artifact-export-network-egress-guard-wiring" `
  -Phase "2782" `
  -Title "Artifact Export Network Egress Guard Wiring" `
  -Markers @(
