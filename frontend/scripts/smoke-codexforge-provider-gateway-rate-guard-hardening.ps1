...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2612 Provider Gateway Rate Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-rate-guard-hardening.ps1" `
  -Route "provider-gateway-rate-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Rate Guard Hardening" `
  -RouteHref "/provider-gateway-rate-guard-hardening" `
  -Phase "2612" `
