...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2793 Artifact Export Backend Wiring Completion" `
  -ScriptFile "smoke-codexforge-artifact-export-backend-wiring-completion.ps1" `
  -Route "artifact-export-backend-wiring-completion" `
  -CommandLabel "Go to Artifact Export Backend Wiring Completion" `
  -RouteHref "/artifact-export-backend-wiring-completion" `
  -Phase "2793" `
  -Title "Artifact Export Backend Wiring Completion" `
  -Markers @(
