...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2667 Audio Storage Contract Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-contract-wiring.ps1" `
  -Route "audio-storage-contract-wiring" `
  -CommandLabel "Go to Audio Storage Contract Wiring" `
  -RouteHref "/audio-storage-contract-wiring" `
  -Phase "2667" `
