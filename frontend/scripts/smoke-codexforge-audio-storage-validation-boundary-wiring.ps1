...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2669 Audio Storage Validation Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-validation-boundary-wiring.ps1" `
  -Route "audio-storage-validation-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Validation Boundary Wiring" `
  -RouteHref "/audio-storage-validation-boundary-wiring" `
  -Phase "2669" `
