...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2679 Audio Storage Recording Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-recording-block-boundary-wiring.ps1" `
  -Route "audio-storage-recording-block-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Recording Block Boundary Wiring" `
  -RouteHref "/audio-storage-recording-block-boundary-wiring" `
  -Phase "2679" `
