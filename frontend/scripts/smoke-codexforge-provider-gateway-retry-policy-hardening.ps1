...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2610 Provider Gateway Retry Policy Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-retry-policy-hardening.ps1" `
  -Route "provider-gateway-retry-policy-hardening" `
  -CommandLabel "Go to Provider Gateway Retry Policy Hardening" `
  -RouteHref "/provider-gateway-retry-policy-hardening" `
  -Phase "2610" `
