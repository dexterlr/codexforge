...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2738 Worker Orchestration Dispatch Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-dispatch-block-boundary-wiring.ps1" `
  -Route "worker-orchestration-dispatch-block-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Dispatch Block Boundary Wiring" `
  -RouteHref "/worker-orchestration-dispatch-block-boundary-wiring" `
  -Phase "2738" `
