...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2743 Worker Orchestration Runtime Deploy Block Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-runtime-deploy-block-wiring.ps1" `
  -Route "worker-orchestration-runtime-deploy-block-wiring" `
  -CommandLabel "Go to Worker Orchestration Runtime Deploy Block Wiring" `
  -RouteHref "/worker-orchestration-runtime-deploy-block-wiring" `
  -Phase "2743" `
