...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2748 Worker Orchestration Network Egress Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-network-egress-guard-wiring.ps1" `
  -Route "worker-orchestration-network-egress-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Network Egress Guard Wiring" `
  -RouteHref "/worker-orchestration-network-egress-guard-wiring" `
  -Phase "2748" `
