...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2768 Artifact Export Packaging Policy Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-packaging-policy-wiring.ps1" `
  -Route "artifact-export-packaging-policy-wiring" `
  -CommandLabel "Go to Artifact Export Packaging Policy Wiring" `
  -RouteHref "/artifact-export-packaging-policy-wiring" `
  -Phase "2768" `
  -Title "Artifact Export Packaging Policy Wiring" `
  -Markers @(
