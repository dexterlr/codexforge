...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2788 Artifact Export Fallback Policy Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-fallback-policy-wiring.ps1" `
  -Route "artifact-export-fallback-policy-wiring" `
  -CommandLabel "Go to Artifact Export Fallback Policy Wiring" `
  -RouteHref "/artifact-export-fallback-policy-wiring" `
  -Phase "2788" `
  -Title "Artifact Export Fallback Policy Wiring" `
  -Markers @(
