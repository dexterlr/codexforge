...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2759 Worker Orchestration Recovery Snapshot Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-recovery-snapshot-wiring.ps1" `
  -Route "worker-orchestration-recovery-snapshot-wiring" `
  -CommandLabel "Go to Worker Orchestration Recovery Snapshot Wiring" `
  -RouteHref "/worker-orchestration-recovery-snapshot-wiring" `
  -Phase "2759" `
