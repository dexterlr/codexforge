...
$sharedBoundaryPath = Join-RepoPath "src" "lib" "codexforge" "provider-backend-adapter-contract-map"
...
Assert-NotMatches $source $unsafeApiNamePattern "unsafe camelCase provider adapter API names"
Write-Host ("[OK] " + $SmokeName + " static provider backend adapter contract smoke passed.")
