...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2730 Worker Orchestration Intake Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-intake-boundary-wiring.ps1" `
  -Route "worker-orchestration-intake-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Intake Boundary Wiring" `
  -RouteHref "/worker-orchestration-intake-boundary-wiring" `
  -Phase "2730" `
