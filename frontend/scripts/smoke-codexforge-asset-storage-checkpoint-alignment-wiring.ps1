...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2662 Asset Storage Checkpoint Alignment Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-checkpoint-alignment-wiring.ps1" `
  -Route "asset-storage-checkpoint-alignment-wiring" `
  -CommandLabel "Go to Asset Storage Checkpoint Alignment Wiring" `
  -RouteHref "/asset-storage-checkpoint-alignment-wiring" `
  -Phase "2662" `
