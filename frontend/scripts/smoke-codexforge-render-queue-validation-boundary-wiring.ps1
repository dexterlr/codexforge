...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2701 Render Queue Validation Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-validation-boundary-wiring.ps1" `
  -Route "render-queue-validation-boundary-wiring" `
  -CommandLabel "Go to Render Queue Validation Boundary Wiring" `
  -RouteHref "/render-queue-validation-boundary-wiring" `
  -Phase "2701" `
