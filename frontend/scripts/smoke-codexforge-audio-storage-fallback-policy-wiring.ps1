...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2691 Audio Storage Fallback Policy Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-fallback-policy-wiring.ps1" `
  -Route "audio-storage-fallback-policy-wiring" `
  -CommandLabel "Go to Audio Storage Fallback Policy Wiring" `
  -RouteHref "/audio-storage-fallback-policy-wiring" `
  -Phase "2691" `
