...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2666 Audio Storage Intake Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-intake-boundary-wiring.ps1" `
  -Route "audio-storage-intake-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Intake Boundary Wiring" `
  -RouteHref "/audio-storage-intake-boundary-wiring" `
  -Phase "2666" `
