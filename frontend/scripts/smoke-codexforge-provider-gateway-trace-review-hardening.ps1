...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2609 Provider Gateway Trace Review Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-trace-review-hardening.ps1" `
  -Route "provider-gateway-trace-review-hardening" `
  -CommandLabel "Go to Provider Gateway Trace Review Hardening" `
  -RouteHref "/provider-gateway-trace-review-hardening" `
  -Phase "2609" `
