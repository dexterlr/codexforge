...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2732 Worker Orchestration Job Envelope Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-job-envelope-wiring.ps1" `
  -Route "worker-orchestration-job-envelope-wiring" `
  -CommandLabel "Go to Worker Orchestration Job Envelope Wiring" `
  -RouteHref "/worker-orchestration-job-envelope-wiring" `
  -Phase "2732" `
