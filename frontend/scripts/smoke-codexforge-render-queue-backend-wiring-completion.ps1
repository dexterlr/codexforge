...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2729 Render Queue Backend Wiring Completion" `
  -ScriptFile "smoke-codexforge-render-queue-backend-wiring-completion.ps1" `
  -Route "render-queue-backend-wiring-completion" `
  -CommandLabel "Go to Render Queue Backend Wiring Completion" `
  -RouteHref "/render-queue-backend-wiring-completion" `
  -Phase "2729" `
