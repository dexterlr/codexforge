...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2712 Render Queue Persistence Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-persistence-guard-wiring.ps1" `
  -Route "render-queue-persistence-guard-wiring" `
  -CommandLabel "Go to Render Queue Persistence Guard Wiring" `
  -RouteHref "/render-queue-persistence-guard-wiring" `
  -Phase "2712" `
