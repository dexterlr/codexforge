...
$domain = "src\lib\codexforge\extension-permission-policy-builder"
$route = "src\app\extension-permission-policy-builder"
...
& (Join-Path $PSScriptRoot "codexforge-local-planning-phase-smoke-helper.ps1") `
  -PhaseName "Phase 319 Extension Permission Policy Builder" `
  -ScriptFile "smoke-codexforge-extension-permission-policy-builder.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "ExtensionPermissionPolicyBuilderPanel" `
  -CommandLabel "Go to Extension Permission Policy Builder" `
  -Modules @("extension-permission-policy-builder-types.ts","extension-permission-policy-builder-summary.ts","index.ts") `
  -Components @("ExtensionPermissionPolicyBuilderPanel.tsx","index.ts") `
  -Exports @("buildExtensionPermissionPolicyBuilderStableKey","buildExtensionPermissionPolicyBuilder","buildExtensionPermissionPolicyBuilders","buildExtensionPermissionPolicyBuilderBoundary","buildExtensionPermissionPolicyBuilderModel","summarizeExtensionPermissionPolicyBuilder","EXTENSION_PERMISSION_POLICY_BUILDER_LANGUAGE") `
  -PlainEnglish @($phaseMarkers + @("Policy builder identity","Source manifest schema review","Requested capabilities","Denied permission scope","Data boundary policy","Audit/recovery requirement","Approval requirement","Blocked reasons","advanced permission details collapsed/secondary") + $sharedExtensionSafetyMarkers) `
  -ExtraRoutes @("/extension-manifest-schema-review","/extension-sandbox-boundary-review","/jarvisd-permissions","/jarvisd-runtime-enforcement","/provider-policy-bundle-export-review")
...
Write-Host "[OK] CodexForge Extension Permission Policy Builder smoke passed."
