...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\real-controlled-operator-trial-packet", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static real controlled operator trial packet smoke passed."
