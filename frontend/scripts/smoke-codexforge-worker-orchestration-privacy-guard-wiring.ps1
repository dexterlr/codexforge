...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2757 Worker Orchestration Privacy Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-privacy-guard-wiring.ps1" `
  -Route "worker-orchestration-privacy-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Privacy Guard Wiring" `
  -RouteHref "/worker-orchestration-privacy-guard-wiring" `
  -Phase "2757" `
