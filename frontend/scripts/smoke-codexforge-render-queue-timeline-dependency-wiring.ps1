...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2704 Render Queue Timeline Dependency Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-timeline-dependency-wiring.ps1" `
  -Route "render-queue-timeline-dependency-wiring" `
  -CommandLabel "Go to Render Queue Timeline Dependency Wiring" `
  -RouteHref "/render-queue-timeline-dependency-wiring" `
  -Phase "2704" `
