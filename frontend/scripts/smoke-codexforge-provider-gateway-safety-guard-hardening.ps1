...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2614 Provider Gateway Safety Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-safety-guard-hardening.ps1" `
  -Route "provider-gateway-safety-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Safety Guard Hardening" `
  -RouteHref "/provider-gateway-safety-guard-hardening" `
  -Phase "2614" `
