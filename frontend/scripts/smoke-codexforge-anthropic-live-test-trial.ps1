...
foreach ($needle in @(
  ...
  Assert-Contains $source $needle "Anthropic live test trial includes $needle"
}
...
Write-Host "[OK] CodexForge Anthropic Live Test Trial smoke passed."
