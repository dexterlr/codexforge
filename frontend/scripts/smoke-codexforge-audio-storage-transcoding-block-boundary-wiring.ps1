...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2681 Audio Storage Transcoding Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-transcoding-block-boundary-wiring.ps1" `
  -Route "audio-storage-transcoding-block-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Transcoding Block Boundary Wiring" `
  -RouteHref "/audio-storage-transcoding-block-boundary-wiring" `
  -Phase "2681" `
