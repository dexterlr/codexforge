...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2755 Worker Orchestration Rate Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-rate-guard-wiring.ps1" `
  -Route "worker-orchestration-rate-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Rate Guard Wiring" `
  -RouteHref "/worker-orchestration-rate-guard-wiring" `
  -Phase "2755" `
