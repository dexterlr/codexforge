...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2676 Audio Storage Upload Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-upload-block-boundary-wiring.ps1" `
  -Route "audio-storage-upload-block-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Upload Block Boundary Wiring" `
  -RouteHref "/audio-storage-upload-block-boundary-wiring" `
  -Phase "2676" `
