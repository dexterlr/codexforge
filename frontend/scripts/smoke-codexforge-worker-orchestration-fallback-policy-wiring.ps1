...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2754 Worker Orchestration Fallback Policy Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-fallback-policy-wiring.ps1" `
  -Route "worker-orchestration-fallback-policy-wiring" `
  -CommandLabel "Go to Worker Orchestration Fallback Policy Wiring" `
  -RouteHref "/worker-orchestration-fallback-policy-wiring" `
  -Phase "2754" `
