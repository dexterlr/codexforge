...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2711 Render Queue Render Execution Block Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-render-execution-block-wiring.ps1" `
  -Route "render-queue-render-execution-block-wiring" `
  -CommandLabel "Go to Render Queue Render Execution Block Wiring" `
  -RouteHref "/render-queue-render-execution-block-wiring" `
  -Phase "2711" `
