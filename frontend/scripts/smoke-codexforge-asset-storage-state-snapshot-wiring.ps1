...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2659 Asset Storage State Snapshot Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-state-snapshot-wiring.ps1" `
  -Route "asset-storage-state-snapshot-wiring" `
  -CommandLabel "Go to Asset Storage State Snapshot Wiring" `
  -RouteHref "/asset-storage-state-snapshot-wiring" `
  -Phase "2659" `
