...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2677 Audio Storage Download Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-download-block-boundary-wiring.ps1" `
  -Route "audio-storage-download-block-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Download Block Boundary Wiring" `
  -RouteHref "/audio-storage-download-block-boundary-wiring" `
  -Phase "2677" `
