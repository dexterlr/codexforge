...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2620 Provider Gateway Provider SDK Import Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-provider-sdk-import-guard-hardening.ps1" `
  -Route "provider-gateway-provider-sdk-import-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Provider SDK Import Guard Hardening" `
  -RouteHref "/provider-gateway-provider-sdk-import-guard-hardening" `
  -Phase "2620" `
