...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2734 Worker Orchestration Capability Policy Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-capability-policy-wiring.ps1" `
  -Route "worker-orchestration-capability-policy-wiring" `
  -CommandLabel "Go to Worker Orchestration Capability Policy Wiring" `
  -RouteHref "/worker-orchestration-capability-policy-wiring" `
  -Phase "2734" `
