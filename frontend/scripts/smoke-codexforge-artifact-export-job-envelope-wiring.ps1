...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2764 Artifact Export Job Envelope Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-job-envelope-wiring.ps1" `
  -Route "artifact-export-job-envelope-wiring" `
  -CommandLabel "Go to Artifact Export Job Envelope Wiring" `
  -RouteHref "/artifact-export-job-envelope-wiring" `
  -Phase "2764" `
  -Title "Artifact Export Job Envelope Wiring" `
  -Markers @(
