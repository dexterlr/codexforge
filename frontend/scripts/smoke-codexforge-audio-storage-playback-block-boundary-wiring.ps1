...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2680 Audio Storage Playback Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-playback-block-boundary-wiring.ps1" `
  -Route "audio-storage-playback-block-boundary-wiring" `
  -CommandLabel "Go to Audio Storage Playback Block Boundary Wiring" `
  -RouteHref "/audio-storage-playback-block-boundary-wiring" `
  -Phase "2680" `
