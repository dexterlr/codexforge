...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2715 Render Queue Provider Import Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-provider-import-guard-wiring.ps1" `
  -Route "render-queue-provider-import-guard-wiring" `
  -CommandLabel "Go to Render Queue Provider Import Guard Wiring" `
  -RouteHref "/render-queue-provider-import-guard-wiring" `
  -Phase "2715" `
