...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2629 Provider Gateway Recovery Handoff Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-recovery-handoff-hardening.ps1" `
  -Route "provider-gateway-recovery-handoff-hardening" `
  -CommandLabel "Go to Provider Gateway Recovery Handoff Hardening" `
  -RouteHref "/provider-gateway-recovery-handoff-hardening" `
  -Phase "2629" `
