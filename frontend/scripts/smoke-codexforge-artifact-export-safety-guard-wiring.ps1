...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2792 Artifact Export Safety Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-safety-guard-wiring.ps1" `
  -Route "artifact-export-safety-guard-wiring" `
  -CommandLabel "Go to Artifact Export Safety Guard Wiring" `
  -RouteHref "/artifact-export-safety-guard-wiring" `
  -Phase "2792" `
  -Title "Artifact Export Safety Guard Wiring" `
  -Markers @(
