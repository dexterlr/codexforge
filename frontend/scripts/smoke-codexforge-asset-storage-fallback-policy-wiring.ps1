...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2654 Asset Storage Fallback Policy Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-fallback-policy-wiring.ps1" `
  -Route "asset-storage-fallback-policy-wiring" `
  -CommandLabel "Go to Asset Storage Fallback Policy Wiring" `
  -RouteHref "/asset-storage-fallback-policy-wiring" `
  -Phase "2654" `
