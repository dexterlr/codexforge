...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2769 Artifact Export Asset Linkage Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-asset-linkage-wiring.ps1" `
  -Route "artifact-export-asset-linkage-wiring" `
  -CommandLabel "Go to Artifact Export Asset Linkage Wiring" `
  -RouteHref "/artifact-export-asset-linkage-wiring" `
  -Phase "2769" `
  -Title "Artifact Export Asset Linkage Wiring" `
  -Markers @(
