...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2739 Worker Orchestration Execution Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-execution-block-boundary-wiring.ps1" `
  -Route "worker-orchestration-execution-block-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Execution Block Boundary Wiring" `
  -RouteHref "/worker-orchestration-execution-block-boundary-wiring" `
  -Phase "2739" `
