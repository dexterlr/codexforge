...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2724 Render Queue Cost Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-cost-guard-wiring.ps1" `
  -Route "render-queue-cost-guard-wiring" `
  -CommandLabel "Go to Render Queue Cost Guard Wiring" `
  -RouteHref "/render-queue-cost-guard-wiring" `
  -Phase "2724" `
