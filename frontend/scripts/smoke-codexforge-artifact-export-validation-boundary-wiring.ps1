...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2765 Artifact Export Validation Boundary Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-validation-boundary-wiring.ps1" `
  -Route "artifact-export-validation-boundary-wiring" `
  -CommandLabel "Go to Artifact Export Validation Boundary Wiring" `
  -RouteHref "/artifact-export-validation-boundary-wiring" `
  -Phase "2765" `
  -Title "Artifact Export Validation Boundary Wiring" `
  -Markers @(
