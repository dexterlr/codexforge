...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2637 Asset Storage Validation Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-validation-boundary-wiring.ps1" `
  -Route "asset-storage-validation-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Validation Boundary Wiring" `
  -RouteHref "/asset-storage-validation-boundary-wiring" `
  -Phase "2637" `
