...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2750 Worker Orchestration Approval Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-approval-boundary-wiring.ps1" `
  -Route "worker-orchestration-approval-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Approval Boundary Wiring" `
  -RouteHref "/worker-orchestration-approval-boundary-wiring" `
  -Phase "2750" `
