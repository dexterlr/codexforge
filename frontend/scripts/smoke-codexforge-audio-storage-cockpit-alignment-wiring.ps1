...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2696 Audio Storage Cockpit Alignment Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-cockpit-alignment-wiring.ps1" `
  -Route "audio-storage-cockpit-alignment-wiring" `
  -CommandLabel "Go to Audio Storage Cockpit Alignment Wiring" `
  -RouteHref "/audio-storage-cockpit-alignment-wiring" `
  -Phase "2696" `
