...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2663 Asset Storage Smoke Coverage Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-smoke-coverage-wiring.ps1" `
  -Route "asset-storage-smoke-coverage-wiring" `
  -CommandLabel "Go to Asset Storage Smoke Coverage Wiring" `
  -RouteHref "/asset-storage-smoke-coverage-wiring" `
  -Phase "2663" `
