...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2731 Worker Orchestration Contract Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-contract-wiring.ps1" `
  -Route "worker-orchestration-contract-wiring" `
  -CommandLabel "Go to Worker Orchestration Contract Wiring" `
  -RouteHref "/worker-orchestration-contract-wiring" `
  -Phase "2731" `
