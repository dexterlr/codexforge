...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2665 Asset Storage Backend Wiring Completion" `
  -ScriptFile "smoke-codexforge-asset-storage-backend-wiring-completion.ps1" `
  -Route "asset-storage-backend-wiring-completion" `
  -CommandLabel "Go to Asset Storage Backend Wiring Completion" `
  -RouteHref "/asset-storage-backend-wiring-completion" `
  -Phase "2665" `
