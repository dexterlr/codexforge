...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2623 Provider Gateway Operator Review Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-operator-review-hardening.ps1" `
  -Route "provider-gateway-operator-review-hardening" `
  -CommandLabel "Go to Provider Gateway Operator Review Hardening" `
  -RouteHref "/provider-gateway-operator-review-hardening" `
  -Phase "2623" `
