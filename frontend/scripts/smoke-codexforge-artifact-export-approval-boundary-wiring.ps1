...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2784 Artifact Export Approval Boundary Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-approval-boundary-wiring.ps1" `
  -Route "artifact-export-approval-boundary-wiring" `
  -CommandLabel "Go to Artifact Export Approval Boundary Wiring" `
  -RouteHref "/artifact-export-approval-boundary-wiring" `
  -Phase "2784" `
  -Title "Artifact Export Approval Boundary Wiring" `
  -Markers @(
