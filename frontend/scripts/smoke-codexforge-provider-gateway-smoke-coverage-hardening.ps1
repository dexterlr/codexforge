...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2631 Provider Gateway Smoke Coverage Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-smoke-coverage-hardening.ps1" `
  -Route "provider-gateway-smoke-coverage-hardening" `
  -CommandLabel "Go to Provider Gateway Smoke Coverage Hardening" `
  -RouteHref "/provider-gateway-smoke-coverage-hardening" `
  -Phase "2631" `
