...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\plan-diff-command-composer", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static plan diff command composer smoke passed."
