...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2779 Artifact Export Credential Isolation Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-credential-isolation-wiring.ps1" `
  -Route "artifact-export-credential-isolation-wiring" `
  -CommandLabel "Go to Artifact Export Credential Isolation Wiring" `
  -RouteHref "/artifact-export-credential-isolation-wiring" `
  -Phase "2779" `
  -Title "Artifact Export Credential Isolation Wiring" `
  -Markers @(
