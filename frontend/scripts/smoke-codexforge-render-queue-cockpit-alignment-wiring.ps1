...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2728 Render Queue Cockpit Alignment Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-cockpit-alignment-wiring.ps1" `
  -Route "render-queue-cockpit-alignment-wiring" `
  -CommandLabel "Go to Render Queue Cockpit Alignment Wiring" `
  -RouteHref "/render-queue-cockpit-alignment-wiring" `
  -Phase "2728" `
