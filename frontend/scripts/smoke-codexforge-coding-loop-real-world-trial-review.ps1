...
$domain = "src\lib\codexforge\coding-loop-real-world-trial-review"
$route = "src\app\coding-loop-real-world-trial-review"
$protectedRoutes = @(
...
& (Join-Path $PSScriptRoot "codexforge-local-project-knowledge-smoke-helper.ps1") `
  -PhaseName "Phase 362 Coding Loop Real-World Trial Review" `
  -ScriptFile "smoke-codexforge-coding-loop-real-world-trial-review.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "CodingLoopRealWorldTrialReviewPanel" `
  -CommandLabel "Go to Coding Loop Real-World Trial Review" `
  -Modules @("coding-loop-real-world-trial-review-types.ts","coding-loop-real-world-trial-review-summary.ts","index.ts") `
  -Components @("CodingLoopRealWorldTrialReviewPanel.tsx","index.ts") `
  -Exports @("buildCodingLoopRealWorldTrialReviewStableKey","buildCodingLoopRealWorldTrialReview","buildCodingLoopRealWorldTrialReviews","buildCodingLoopRealWorldTrialReviewBoundary","buildCodingLoopRealWorldTrialReviewModel","summarizeCodingLoopRealWorldTrialReview","CODING_LOOP_REAL_WORLD_TRIAL_REVIEW_LANGUAGE") `
  -PhaseMarkers $phaseMarkers `
  -PlainEnglish @(@("Coding trial identity","Source first real operator workflow trial","Operator scenario","Expected approval gates","Validation evidence summary","Blocked real actions","Trial outcome notes","Next loop route","advanced coding trial details collapsed/secondary") + $sharedRealWorldSafetyMarkers) `
  -ExtraRoutes @("/first-real-operator-workflow-trial","/code-flow","/review-inbox","/research-loop-real-world-trial-review")
...
Write-Host "[OK] CodexForge Coding Loop Real-World Trial Review smoke passed."
