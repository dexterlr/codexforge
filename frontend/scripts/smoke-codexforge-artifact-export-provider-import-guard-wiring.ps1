...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2781 Artifact Export Provider Import Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-provider-import-guard-wiring.ps1" `
  -Route "artifact-export-provider-import-guard-wiring" `
  -CommandLabel "Go to Artifact Export Provider Import Guard Wiring" `
  -RouteHref "/artifact-export-provider-import-guard-wiring" `
  -Phase "2781" `
  -Title "Artifact Export Provider Import Guard Wiring" `
  -Markers @(
