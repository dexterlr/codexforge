...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2717 Render Queue Audit Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-audit-boundary-wiring.ps1" `
  -Route "render-queue-audit-boundary-wiring" `
  -CommandLabel "Go to Render Queue Audit Boundary Wiring" `
  -RouteHref "/render-queue-audit-boundary-wiring" `
  -Phase "2717" `
