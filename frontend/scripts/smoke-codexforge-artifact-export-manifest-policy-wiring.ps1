...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2767 Artifact Export Manifest Policy Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-manifest-policy-wiring.ps1" `
  -Route "artifact-export-manifest-policy-wiring" `
  -CommandLabel "Go to Artifact Export Manifest Policy Wiring" `
  -RouteHref "/artifact-export-manifest-policy-wiring" `
  -Phase "2767" `
  -Title "Artifact Export Manifest Policy Wiring" `
  -Markers @(
