...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2695 Audio Storage Safety Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-safety-guard-wiring.ps1" `
  -Route "audio-storage-safety-guard-wiring" `
  -CommandLabel "Go to Audio Storage Safety Guard Wiring" `
  -RouteHref "/audio-storage-safety-guard-wiring" `
  -Phase "2695" `
