...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2780 Artifact Export Token Isolation Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-token-isolation-wiring.ps1" `
  -Route "artifact-export-token-isolation-wiring" `
  -CommandLabel "Go to Artifact Export Token Isolation Wiring" `
  -RouteHref "/artifact-export-token-isolation-wiring" `
  -Phase "2780" `
  -Title "Artifact Export Token Isolation Wiring" `
  -Markers @(
