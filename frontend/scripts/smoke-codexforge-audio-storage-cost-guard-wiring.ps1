...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2693 Audio Storage Cost Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-cost-guard-wiring.ps1" `
  -Route "audio-storage-cost-guard-wiring" `
  -CommandLabel "Go to Audio Storage Cost Guard Wiring" `
  -RouteHref "/audio-storage-cost-guard-wiring" `
  -Phase "2693" `
