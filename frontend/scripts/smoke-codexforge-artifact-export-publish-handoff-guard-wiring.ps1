...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2777 Artifact Export Publish Handoff Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-publish-handoff-guard-wiring.ps1" `
  -Route "artifact-export-publish-handoff-guard-wiring" `
  -CommandLabel "Go to Artifact Export Publish Handoff Guard Wiring" `
  -RouteHref "/artifact-export-publish-handoff-guard-wiring" `
  -Phase "2777" `
  -Title "Artifact Export Publish Handoff Guard Wiring" `
  -Markers @(
