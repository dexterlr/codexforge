...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2625 Provider Gateway Blocked Action Matrix Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-blocked-action-matrix-hardening.ps1" `
  -Route "provider-gateway-blocked-action-matrix-hardening" `
  -CommandLabel "Go to Provider Gateway Blocked Action Matrix Hardening" `
  -RouteHref "/provider-gateway-blocked-action-matrix-hardening" `
  -Phase "2625" `
