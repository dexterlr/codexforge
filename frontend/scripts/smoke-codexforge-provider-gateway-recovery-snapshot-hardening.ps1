...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2622 Provider Gateway Recovery Snapshot Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-recovery-snapshot-hardening.ps1" `
  -Route "provider-gateway-recovery-snapshot-hardening" `
  -CommandLabel "Go to Provider Gateway Recovery Snapshot Hardening" `
  -RouteHref "/provider-gateway-recovery-snapshot-hardening" `
  -Phase "2622" `
