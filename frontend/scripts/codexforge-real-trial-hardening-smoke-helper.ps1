...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\real-trial-hardening", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static real trial hardening smoke passed."
