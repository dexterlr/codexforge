...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2628 Provider Gateway Result Review Handoff Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-result-review-handoff-hardening.ps1" `
  -Route "provider-gateway-result-review-handoff-hardening" `
  -CommandLabel "Go to Provider Gateway Result Review Handoff Hardening" `
  -RouteHref "/provider-gateway-result-review-handoff-hardening" `
  -Phase "2628" `
