...
Assert-True ($LatestOverrideText -match "buildRouteLatestMessageOverrideContext") "latest-message module uses shared override context helper"
Assert-True ($LatestOverrideText -match "getLatestMessageOverridePreferredPath") "latest-message module uses shared preferred path helper"
