...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2756 Worker Orchestration Cost Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-cost-guard-wiring.ps1" `
  -Route "worker-orchestration-cost-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Cost Guard Wiring" `
  -RouteHref "/worker-orchestration-cost-guard-wiring" `
  -Phase "2756" `
