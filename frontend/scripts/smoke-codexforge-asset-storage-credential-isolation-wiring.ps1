...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2644 Asset Storage Credential Isolation Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-credential-isolation-wiring.ps1" `
  -Route "asset-storage-credential-isolation-wiring" `
  -CommandLabel "Go to Asset Storage Credential Isolation Wiring" `
  -RouteHref "/asset-storage-credential-isolation-wiring" `
  -Phase "2644" `
