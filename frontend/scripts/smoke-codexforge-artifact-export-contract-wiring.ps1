...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2763 Artifact Export Contract Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-contract-wiring.ps1" `
  -Route "artifact-export-contract-wiring" `
  -CommandLabel "Go to Artifact Export Contract Wiring" `
  -RouteHref "/artifact-export-contract-wiring" `
  -Phase "2763" `
  -Title "Artifact Export Contract Wiring" `
  -Markers @(
