...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2725 Render Queue Privacy Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-privacy-guard-wiring.ps1" `
  -Route "render-queue-privacy-guard-wiring" `
  -CommandLabel "Go to Render Queue Privacy Guard Wiring" `
  -RouteHref "/render-queue-privacy-guard-wiring" `
  -Phase "2725" `
