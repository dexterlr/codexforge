...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2635 Asset Storage Contract Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-contract-wiring.ps1" `
  -Route "asset-storage-contract-wiring" `
  -CommandLabel "Go to Asset Storage Contract Wiring" `
  -RouteHref "/asset-storage-contract-wiring" `
  -Phase "2635" `
