...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2699 Render Queue Contract Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-contract-wiring.ps1" `
  -Route "render-queue-contract-wiring" `
  -CommandLabel "Go to Render Queue Contract Wiring" `
  -RouteHref "/render-queue-contract-wiring" `
  -Phase "2699" `
