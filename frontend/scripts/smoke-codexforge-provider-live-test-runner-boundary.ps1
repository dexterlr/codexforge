...
foreach ($needle in @(
  ...
  Assert-Contains $source $needle "provider live test runner boundary includes $needle"
}
...
Write-Host "[OK] CodexForge Provider Live Test Runner Boundary smoke passed."
