...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2745 Worker Orchestration Credential Isolation Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-credential-isolation-wiring.ps1" `
  -Route "worker-orchestration-credential-isolation-wiring" `
  -CommandLabel "Go to Worker Orchestration Credential Isolation Wiring" `
  -RouteHref "/worker-orchestration-credential-isolation-wiring" `
  -Phase "2745" `
