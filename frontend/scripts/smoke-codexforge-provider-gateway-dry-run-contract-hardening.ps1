...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2627 Provider Gateway Dry-Run Contract Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-dry-run-contract-hardening.ps1" `
  -Route "provider-gateway-dry-run-contract-hardening" `
  -CommandLabel "Go to Provider Gateway Dry-Run Contract Hardening" `
  -RouteHref "/provider-gateway-dry-run-contract-hardening" `
  -Phase "2627" `
