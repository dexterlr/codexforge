...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2774 Artifact Export Download Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-download-block-boundary-wiring.ps1" `
  -Route "artifact-export-download-block-boundary-wiring" `
  -CommandLabel "Go to Artifact Export Download Block Boundary Wiring" `
  -RouteHref "/artifact-export-download-block-boundary-wiring" `
  -Phase "2774" `
  -Title "Artifact Export Download Block Boundary Wiring" `
  -Markers @(
