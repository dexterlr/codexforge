...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2753 Worker Orchestration Retry Policy Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-retry-policy-wiring.ps1" `
  -Route "worker-orchestration-retry-policy-wiring" `
  -CommandLabel "Go to Worker Orchestration Retry Policy Wiring" `
  -RouteHref "/worker-orchestration-retry-policy-wiring" `
  -Phase "2753" `
