...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2607 Provider Gateway Redaction Boundary Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-redaction-boundary-hardening.ps1" `
  -Route "provider-gateway-redaction-boundary-hardening" `
  -CommandLabel "Go to Provider Gateway Redaction Boundary Hardening" `
  -RouteHref "/provider-gateway-redaction-boundary-hardening" `
  -Phase "2607" `
