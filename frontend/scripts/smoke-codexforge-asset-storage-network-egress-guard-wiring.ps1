...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2647 Asset Storage Network Egress Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-network-egress-guard-wiring.ps1" `
  -Route "asset-storage-network-egress-guard-wiring" `
  -CommandLabel "Go to Asset Storage Network Egress Guard Wiring" `
  -RouteHref "/asset-storage-network-egress-guard-wiring" `
  -Phase "2647" `
