...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2751 Worker Orchestration Redaction Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-redaction-boundary-wiring.ps1" `
  -Route "worker-orchestration-redaction-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Redaction Boundary Wiring" `
  -RouteHref "/worker-orchestration-redaction-boundary-wiring" `
  -Phase "2751" `
