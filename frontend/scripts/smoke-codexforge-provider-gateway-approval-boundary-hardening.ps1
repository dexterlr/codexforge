...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2604 Provider Gateway Approval Boundary Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-approval-boundary-hardening.ps1" `
  -Route "provider-gateway-approval-boundary-hardening" `
  -CommandLabel "Go to Provider Gateway Approval Boundary Hardening" `
  -RouteHref "/provider-gateway-approval-boundary-hardening" `
  -Phase "2604" `
