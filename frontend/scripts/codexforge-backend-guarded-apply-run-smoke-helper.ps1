...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\backend-guarded-apply-run", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static backend guarded apply/run smoke passed."
