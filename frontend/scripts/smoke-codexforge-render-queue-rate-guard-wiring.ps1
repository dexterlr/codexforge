...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2723 Render Queue Rate Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-rate-guard-wiring.ps1" `
  -Route "render-queue-rate-guard-wiring" `
  -CommandLabel "Go to Render Queue Rate Guard Wiring" `
  -RouteHref "/render-queue-rate-guard-wiring" `
  -Phase "2723" `
