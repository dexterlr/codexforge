...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2708 Render Queue Worker Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-worker-block-boundary-wiring.ps1" `
  -Route "render-queue-worker-block-boundary-wiring" `
  -CommandLabel "Go to Render Queue Worker Block Boundary Wiring" `
  -RouteHref "/render-queue-worker-block-boundary-wiring" `
  -Phase "2708" `
