...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2694 Audio Storage Privacy Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-privacy-guard-wiring.ps1" `
  -Route "audio-storage-privacy-guard-wiring" `
  -CommandLabel "Go to Audio Storage Privacy Guard Wiring" `
  -RouteHref "/audio-storage-privacy-guard-wiring" `
  -Phase "2694" `
