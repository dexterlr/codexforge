...
$sourceParts = @()
foreach ($scanRoot in @($Domain, $Route, "src\lib\codexforge\goal-compiler", "src\lib\codexforge\unified-cockpit")) {
...
Write-Host "[OK] $SmokeName static goal compiler smoke passed."
