...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2735 Worker Orchestration Isolation Policy Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-isolation-policy-wiring.ps1" `
  -Route "worker-orchestration-isolation-policy-wiring" `
  -CommandLabel "Go to Worker Orchestration Isolation Policy Wiring" `
  -RouteHref "/worker-orchestration-isolation-policy-wiring" `
  -Phase "2735" `
