...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2692 Audio Storage Rate Guard Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-rate-guard-wiring.ps1" `
  -Route "audio-storage-rate-guard-wiring" `
  -CommandLabel "Go to Audio Storage Rate Guard Wiring" `
  -RouteHref "/audio-storage-rate-guard-wiring" `
  -Phase "2692" `
