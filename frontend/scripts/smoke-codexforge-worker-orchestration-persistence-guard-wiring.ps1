...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2744 Worker Orchestration Persistence Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-persistence-guard-wiring.ps1" `
  -Route "worker-orchestration-persistence-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Persistence Guard Wiring" `
  -RouteHref "/worker-orchestration-persistence-guard-wiring" `
  -Phase "2744" `
