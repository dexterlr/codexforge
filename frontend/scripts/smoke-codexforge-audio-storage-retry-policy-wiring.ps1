...
Invoke-CodexForgeAudioStorageBackendWiringSmoke `
  -SmokeName "Phase 2690 Audio Storage Retry Policy Wiring" `
  -ScriptFile "smoke-codexforge-audio-storage-retry-policy-wiring.ps1" `
  -Route "audio-storage-retry-policy-wiring" `
  -CommandLabel "Go to Audio Storage Retry Policy Wiring" `
  -RouteHref "/audio-storage-retry-policy-wiring" `
  -Phase "2690" `
