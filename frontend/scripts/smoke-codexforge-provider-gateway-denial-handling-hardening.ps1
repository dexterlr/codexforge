...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2606 Provider Gateway Denial Handling Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-denial-handling-hardening.ps1" `
  -Route "provider-gateway-denial-handling-hardening" `
  -CommandLabel "Go to Provider Gateway Denial Handling Hardening" `
  -RouteHref "/provider-gateway-denial-handling-hardening" `
  -Phase "2606" `
