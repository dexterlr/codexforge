...
$domain = "src\lib\codexforge\full-smoke-suite-stability-pass"
$route = "src\app\full-smoke-suite-stability-pass"
$protectedRoutes = @(
...
& (Join-Path $PSScriptRoot "codexforge-local-project-knowledge-smoke-helper.ps1") `
  -PhaseName "Phase 382 Full Smoke Suite Stability Pass" `
  -ScriptFile "smoke-codexforge-full-smoke-suite-stability-pass.ps1" `
  -Domain $domain `
  -Route $route `
  -MainPanel "FullSmokeSuiteStabilityPassPanel" `
  -CommandLabel "Go to Full Smoke Suite Stability Pass" `
  -Modules @("full-smoke-suite-stability-pass-types.ts","full-smoke-suite-stability-pass-summary.ts","index.ts") `
  -Components @("FullSmokeSuiteStabilityPassPanel.tsx","index.ts") `
  -Exports @("buildFullSmokeSuiteStabilityPassStableKey","buildFullSmokeSuiteStabilityReview","buildFullSmokeSuiteStabilityReviews","buildFullSmokeSuiteStabilityPassBoundary","buildFullSmokeSuiteStabilityPassModel","summarizeFullSmokeSuiteStabilityPass","FULL_SMOKE_SUITE_STABILITY_PASS_LANGUAGE") `
  -PhaseMarkers $phaseMarkers `
  -PlainEnglish @(@("Smoke stability identity","Latest validation checklist","Known flaky areas","Blocked stability risks","Beta candidate route","Feedback/intake route","advanced smoke stability details collapsed/secondary") + $betaReadinessSafetyMarkers) `
  -ExtraRoutes @("/foundation-beta-candidate","/beta-trial-intake-review","/beta-feedback-inbox","/secrets-token-storage-regression-sweep")
...
Write-Host "[OK] CodexForge Full Smoke Suite Stability Pass smoke passed."
