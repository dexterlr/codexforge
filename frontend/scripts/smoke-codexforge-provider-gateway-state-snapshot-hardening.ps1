...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2621 Provider Gateway State Snapshot Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-state-snapshot-hardening.ps1" `
  -Route "provider-gateway-state-snapshot-hardening" `
  -CommandLabel "Go to Provider Gateway State Snapshot Hardening" `
  -RouteHref "/provider-gateway-state-snapshot-hardening" `
  -Phase "2621" `
