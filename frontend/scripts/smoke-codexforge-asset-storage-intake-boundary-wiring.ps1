...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2634 Asset Storage Intake Boundary Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-intake-boundary-wiring.ps1" `
  -Route "asset-storage-intake-boundary-wiring" `
  -CommandLabel "Go to Asset Storage Intake Boundary Wiring" `
  -RouteHref "/asset-storage-intake-boundary-wiring" `
  -Phase "2634" `
