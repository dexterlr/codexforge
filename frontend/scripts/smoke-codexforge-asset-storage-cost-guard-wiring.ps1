...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2656 Asset Storage Cost Guard Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-cost-guard-wiring.ps1" `
  -Route "asset-storage-cost-guard-wiring" `
  -CommandLabel "Go to Asset Storage Cost Guard Wiring" `
  -RouteHref "/asset-storage-cost-guard-wiring" `
  -Phase "2656" `
