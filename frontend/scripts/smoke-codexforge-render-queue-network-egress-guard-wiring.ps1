...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2716 Render Queue Network Egress Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-network-egress-guard-wiring.ps1" `
  -Route "render-queue-network-egress-guard-wiring" `
  -CommandLabel "Go to Render Queue Network Egress Guard Wiring" `
  -RouteHref "/render-queue-network-egress-guard-wiring" `
  -Phase "2716" `
