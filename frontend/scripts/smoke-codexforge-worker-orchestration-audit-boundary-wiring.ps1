...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2749 Worker Orchestration Audit Boundary Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-audit-boundary-wiring.ps1" `
  -Route "worker-orchestration-audit-boundary-wiring" `
  -CommandLabel "Go to Worker Orchestration Audit Boundary Wiring" `
  -RouteHref "/worker-orchestration-audit-boundary-wiring" `
  -Phase "2749" `
