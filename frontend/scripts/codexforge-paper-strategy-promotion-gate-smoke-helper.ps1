...
$sourceParts = @()
foreach ($scanRoot in @("src\lib\codexforge\paper-strategy-promotion-gate", $Domain, $Route, (Join-Path "scripts" $ScriptFile))) {
...
Assert-Contains $source "PaperStrategyPromotionGateRoutePanel" "main route panel"
Assert-Contains $source "PaperStrategyPromotionGateCockpitSummaryPanel" "cockpit paper strategy promotion gate summary panel"
Assert-Contains $cockpitPanel "PaperStrategyPromotionGateCockpitSummaryPanel" "cockpit navigation cleanup paper strategy promotion gate summary"
Assert-Contains $unifiedCockpit "PaperStrategyPromotionGateCockpitSummaryPanel" "unified cockpit paper strategy promotion gate summary"
...
Write-Host ("[OK] " + $SmokeName + " static paper strategy promotion gate smoke passed.")
