...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2742 Worker Orchestration Port Binding Block Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-port-binding-block-wiring.ps1" `
  -Route "worker-orchestration-port-binding-block-wiring" `
  -CommandLabel "Go to Worker Orchestration Port Binding Block Wiring" `
  -RouteHref "/worker-orchestration-port-binding-block-wiring" `
  -Phase "2742" `
