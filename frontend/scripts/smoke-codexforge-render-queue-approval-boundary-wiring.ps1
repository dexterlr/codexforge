...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2718 Render Queue Approval Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-approval-boundary-wiring.ps1" `
  -Route "render-queue-approval-boundary-wiring" `
  -CommandLabel "Go to Render Queue Approval Boundary Wiring" `
  -RouteHref "/render-queue-approval-boundary-wiring" `
  -Phase "2718" `
