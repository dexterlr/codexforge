...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2707 Render Queue Dispatch Block Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-dispatch-block-boundary-wiring.ps1" `
  -Route "render-queue-dispatch-block-boundary-wiring" `
  -CommandLabel "Go to Render Queue Dispatch Block Boundary Wiring" `
  -RouteHref "/render-queue-dispatch-block-boundary-wiring" `
  -Phase "2707" `
