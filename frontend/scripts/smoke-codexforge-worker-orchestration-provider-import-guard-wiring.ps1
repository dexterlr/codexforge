...
Invoke-CodexForgeWorkerOrchestrationBackendWiringSmoke `
  -SmokeName "Phase 2747 Worker Orchestration Provider Import Guard Wiring" `
  -ScriptFile "smoke-codexforge-worker-orchestration-provider-import-guard-wiring.ps1" `
  -Route "worker-orchestration-provider-import-guard-wiring" `
  -CommandLabel "Go to Worker Orchestration Provider Import Guard Wiring" `
  -RouteHref "/worker-orchestration-provider-import-guard-wiring" `
  -Phase "2747" `
