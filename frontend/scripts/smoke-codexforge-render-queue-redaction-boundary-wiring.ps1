...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2719 Render Queue Redaction Boundary Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-redaction-boundary-wiring.ps1" `
  -Route "render-queue-redaction-boundary-wiring" `
  -CommandLabel "Go to Render Queue Redaction Boundary Wiring" `
  -RouteHref "/render-queue-redaction-boundary-wiring" `
  -Phase "2719" `
