...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2624 Provider Gateway Completion Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-completion-guard-hardening.ps1" `
  -Route "provider-gateway-completion-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Completion Guard Hardening" `
  -RouteHref "/provider-gateway-completion-guard-hardening" `
  -Phase "2624" `
