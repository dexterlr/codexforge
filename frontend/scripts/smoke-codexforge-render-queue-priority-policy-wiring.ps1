...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2705 Render Queue Priority Policy Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-priority-policy-wiring.ps1" `
  -Route "render-queue-priority-policy-wiring" `
  -CommandLabel "Go to Render Queue Priority Policy Wiring" `
  -RouteHref "/render-queue-priority-policy-wiring" `
  -Phase "2705" `
