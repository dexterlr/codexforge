...
Invoke-CodexForgeArtifactExportBackendWiringSmoke `
  -SmokeName "Phase 2790 Artifact Export Cost Guard Wiring" `
  -ScriptFile "smoke-codexforge-artifact-export-cost-guard-wiring.ps1" `
  -Route "artifact-export-cost-guard-wiring" `
  -CommandLabel "Go to Artifact Export Cost Guard Wiring" `
  -RouteHref "/artifact-export-cost-guard-wiring" `
  -Phase "2790" `
  -Title "Artifact Export Cost Guard Wiring" `
  -Markers @(
