...
$sourceParts = @()
foreach ($scanRoot in @("src\lib\codexforge\cockpit-trading-workflow-polish", $Domain, $Route, (Join-Path "scripts" $ScriptFile))) {
...
Assert-Contains $source "CockpitTradingWorkflowPolishRoutePanel" "main route panel"
Assert-Contains $source "CockpitTradingWorkflowPolishCockpitSummaryPanel" "cockpit trading workflow polish summary panel"
Assert-Contains $cockpitPanel "CockpitTradingWorkflowPolishCockpitSummaryPanel" "cockpit navigation cleanup trading workflow polish summary"
Assert-Contains $unifiedCockpit "CockpitTradingWorkflowPolishCockpitSummaryPanel" "unified cockpit trading workflow polish summary"
...
Write-Host ("[OK] " + $SmokeName + " static cockpit trading workflow polish smoke passed.")
