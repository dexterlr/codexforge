...
Assert-Contains $routeSource "<RealCodingFlowPanel />" "/code-flow renders Real Coding Flow"
Assert-Contains $aiSource 'redirect("/jarvis")' "/ai redirects to canonical Jarvis"
Assert-NotContains $aiSource "RealCodingFlowPanel" "/ai mounts no competing Real Coding Flow panel"
