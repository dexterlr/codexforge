...
Invoke-CodexForgeProviderGatewayHardeningSmoke `
  -SmokeName "Phase 2615 Provider Gateway Privacy Guard Hardening" `
  -ScriptFile "smoke-codexforge-provider-gateway-privacy-guard-hardening.ps1" `
  -Route "provider-gateway-privacy-guard-hardening" `
  -CommandLabel "Go to Provider Gateway Privacy Guard Hardening" `
  -RouteHref "/provider-gateway-privacy-guard-hardening" `
  -Phase "2615" `
