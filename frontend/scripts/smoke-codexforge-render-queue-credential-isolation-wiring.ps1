...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2713 Render Queue Credential Isolation Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-credential-isolation-wiring.ps1" `
  -Route "render-queue-credential-isolation-wiring" `
  -CommandLabel "Go to Render Queue Credential Isolation Wiring" `
  -RouteHref "/render-queue-credential-isolation-wiring" `
  -Phase "2713" `
