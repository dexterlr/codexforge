...
Assert-True ($entries.Count -eq 65) "aggregate executable entry count is 65"
...
Assert-True ($requiredCount -eq 62 -and $optionalCount -eq 3) "aggregate split is 62 required and 3 optional"
