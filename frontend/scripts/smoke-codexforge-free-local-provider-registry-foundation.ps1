...
Assert-True ($entries.Count -eq 66) "aggregate executable entry count is 66"
...
Assert-True ($requiredCount -eq 63 -and $optionalCount -eq 3) "aggregate split is 63 required and 3 optional"
