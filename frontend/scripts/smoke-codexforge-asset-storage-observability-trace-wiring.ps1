...
Invoke-CodexForgeAssetStorageBackendWiringSmoke `
  -SmokeName "Phase 2652 Asset Storage Observability Trace Wiring" `
  -ScriptFile "smoke-codexforge-asset-storage-observability-trace-wiring.ps1" `
  -Route "asset-storage-observability-trace-wiring" `
  -CommandLabel "Go to Asset Storage Observability Trace Wiring" `
  -RouteHref "/asset-storage-observability-trace-wiring" `
  -Phase "2652" `
