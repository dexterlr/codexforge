...
Invoke-CodexForgeRenderQueueBackendWiringSmoke `
  -SmokeName "Phase 2726 Render Queue Safety Guard Wiring" `
  -ScriptFile "smoke-codexforge-render-queue-safety-guard-wiring.ps1" `
  -Route "render-queue-safety-guard-wiring" `
  -CommandLabel "Go to Render Queue Safety Guard Wiring" `
  -RouteHref "/render-queue-safety-guard-wiring" `
  -Phase "2726" `
